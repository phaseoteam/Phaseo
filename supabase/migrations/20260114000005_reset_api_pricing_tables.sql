-- Full reset of api pricing/provider tables to match new schema.
-- Drops dependent tables first, then recreates in correct order.
...
-- =========================
create table if not exists public.data_api_provider_capabilities_param (
  ...
  primary key (provider_api_model_id, capability_id, param_key),
  foreign key (provider_api_model_id, capability_id)
