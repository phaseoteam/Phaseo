-- Signup trigger policy update:
-- - public.users upsert is mandatory and must fail signup on error.
-- - email outbox + discord notification side effects remain best-effort.
