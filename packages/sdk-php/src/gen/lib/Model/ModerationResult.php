 ...
 */
class ModerationResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModerationResult';
    ...
    protected static $setters = [
        ...
        'category_scores' => 'setCategoryScores'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('category_scores', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['category_scores'];
    }
     ...
     * @return self
     */
    public function setCategoryScores($category_scores)
    {
        if (is_null($category_scores)) {
            throw new \InvalidArgumentException('non-nullable category_scores cannot be null');
        }
        $this->container['category_scores'] = $category_scores;
