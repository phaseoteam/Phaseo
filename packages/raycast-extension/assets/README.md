...
convert apps/web/src/app/favicon.ico -resize 512x512 packages/raycast-extension/assets/icon.png

# Or manually using any image editing tool
# 1. Open apps/web/src/app/favicon.ico
# 2. Resize to 512x512
# 3. Export as PNG to packages/raycast-extension/assets/icon.png
```
