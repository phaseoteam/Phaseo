...
/**
 * ResponsesRequestReasoning Class Doc Comment
 *
 * @category Class
 * @package  AIStats\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class ResponsesRequestReasoning implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponsesRequest_reasoning';
    ...
    */
    ...
    public function setMaxTokens($max_tokens)
    {
        ...
        if (($max_tokens < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_tokens when calling ResponsesRequestReasoning., must be bigger than or equal to 0.');
        }
