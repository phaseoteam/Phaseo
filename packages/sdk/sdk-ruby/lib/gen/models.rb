module AiStats
  module Gen
    ...
    AnthropicMessagesRequest = Struct.new(:debug, :max_tokens, :messages, :metadata, :model, :provider, :stream, :system, :temperature, :tool_choice, :tools, :top_k, :top_p, keyword_init: true)
    ...
    ChatCompletionsRequest = Struct.new(:debug, :frequency_penalty, :logit_bias, :logprobs, :max_output_tokens, :max_tool_calls, :messages, :meta, :model, :parallel_tool_calls, :presence_penalty, :provider, :reasoning, :response_format, :seed, :service_tier, :stream, :system, :temperature, :tool_choice, :tools, :top_k, :top_logprobs, :top_p, :usage, :user_id, keyword_init: true)
