module AiStats
  module Gen
    ...
    AnthropicMessagesRequest = Struct.new(:debug, :image_config, :imageConfig, :max_tokens, :messages, :metadata, :modalities, :model, :provider, :response_modalities, :responseModalities, :stream, :system, :temperature, :thinking, :tool_choice, :tools, :top_k, :top_p, keyword_init: true)
    ...
    ChatCompletionsRequest = Struct.new(:debug, :frequency_penalty, :image_config, :imageConfig, :logit_bias, :logprobs, :max_completion_tokens, :max_output_tokens, :max_tokens, :max_tool_calls, :messages, :meta, :modalities, :model, :parallel_tool_calls, :presence_penalty, :provider, :reasoning, :response_format, :response_modalities, :responseModalities, :seed, :service_tier, :speed, :stream, :stream_options, :system, :temperature, :thinking, :tool_choice, :tools, :top_k, :top_logprobs, :top_p, :usage, :user, :user_id, keyword_init: true)
    ...
    ImageConfig = Struct.new(:aspect_ratio, :aspectRatio, :font_inputs, :fontInputs, :image_size, :imageSize, :include_rai_reason, :includeRaiReason, :reference_images, :referenceImages, :super_resolution_references, :superResolutionReferences, keyword_init: true)
    ...
    ReasoningConfig = Struct.new(:effort, :enabled, :include_thoughts, :includeThoughts, :max_tokens, :summary, keyword_init: true)
    ResponsesInputItem = Struct.new(:content, :phase, :role, :type, keyword_init: true)
    ResponsesOutputItem = Struct.new(:content, :phase, :role, :type, keyword_init: true)
    ResponsesRequest = Struct.new(:background, :conversation, :debug, :image_config, :imageConfig, :include, :input, :input_items, :instructions, :max_completion_tokens, :max_output_tokens, :max_tokens, :max_tool_calls, :meta, :metadata, :modalities, :model, :parallel_tool_calls, :previous_response_id, :prompt, :prompt_cache_key, :prompt_cache_retention, :provider, :provider_options, :providerOptions, :reasoning, :response_modalities, :responseModalities, :safety_identifier, :service_tier, :speed, :store, :stream, :stream_options, :temperature, :text, :thinking, :tool_choice, :tools, :top_logprobs, :top_p, :truncation, :usage, :user, keyword_init: true)
