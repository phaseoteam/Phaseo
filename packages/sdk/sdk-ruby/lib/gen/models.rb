module AiStats
  module Gen
    ...
    ResponsesRequest = Struct.new(:background, :conversation, :debug, :image_config, :imageConfig, :include, :input, :input_items, :instructions, :max_completion_tokens, :max_output_tokens, :max_tokens, :max_tool_calls, :meta, :metadata, :modalities, :model, :parallel_tool_calls, :previous_response_id, :prompt, :prompt_cache_key, :prompt_cache_retention, :provider, :reasoning, :response_modalities, :responseModalities, :safety_identifier, :service_tier, :speed, :store, :stream, :stream_options, :temperature, :text, :thinking, :tool_choice, :tools, :top_logprobs, :top_p, :truncation, :usage, :user, keyword_init: true)
