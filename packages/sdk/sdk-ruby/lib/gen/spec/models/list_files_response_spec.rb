...
# Unit tests for AIStatsSdk::ListFilesResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AIStatsSdk::ListFilesResponse do
  #let(:instance) { AIStatsSdk::ListFilesResponse.new }

  describe 'test an instance of ListFilesResponse' do
    it 'should create an instance of ListFilesResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AIStatsSdk::ListFilesResponse)
    end
  end
