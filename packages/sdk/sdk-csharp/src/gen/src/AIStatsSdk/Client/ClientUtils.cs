...
[assembly: InternalsVisibleTo("AIStatsSdk.Test")]
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is AudioContentPartInputAudio.FormatEnum audioContentPartInputAudioFormatEnum)
                return AudioContentPartInputAudio.FormatEnumToJsonValue(audioContentPartInputAudioFormatEnum);
            if (obj is AudioSpeechRequest.FormatEnum audioSpeechRequestFormatEnum)
            ...
            if (obj is TextModerationInput.TypeEnum textModerationInputTypeEnum)
                return TextModerationInput.TypeEnumToJsonValue(textModerationInputTypeEnum);
            if (obj is ToolCall.TypeEnum toolCallTypeEnum)
