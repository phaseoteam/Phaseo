...
namespace AIStatsSdk.Model
{
    ...
    public partial class ErrorResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ErrorResponse(Option<bool?> ok = default, Option<string?> error = default, Option<string?> message = default)
        {
            OkOption = ok;
            ErrorOption = error;
        ...
        /// </summary>
        /* <example>Human-readable error message</example> */
    ...
    public class ErrorResponseJsonConverter : JsonConverter<ErrorResponse>
    {
        ...
        public override ErrorResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (ok.IsSet && ok.Value == null)
                throw new ArgumentNullException(nameof(ok), "Property is not nullable for class ErrorResponse.");
            ...
            return new ErrorResponse(ok, error, message);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, ErrorResponse errorResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (errorResponse.OkOption.IsSet)
                writer.WriteBoolean("ok", errorResponse.OkOption.Value!.Value);
