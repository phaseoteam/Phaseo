...
namespace AIStatsSdk.Model
{
    ...
    public partial class OcrRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public OcrRequest(string model, string image, Option<string?> language = default, Option<bool?> echoUpstreamRequest = default, Option<DebugOptions?> debug = default, Option<ProviderRoutingOptions?> provider = default)
        {
            Model = model;
            Image = image;
    ...
    public class OcrRequestJsonConverter : JsonConverter<OcrRequest>
    {
        ...
        public override OcrRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new OcrRequest(model.Value!, image.Value!, language, echoUpstreamRequest, debug, provider);
        }
