...
inputSpec: apps/docs/openapi/v1/openapi.yaml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: 'c7479db4-050e-42cb-9083-caea14828122'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            ICalculatePricingApiResponse apiResponse = await api.CalculatePricingAsync("todo");
            CalculatePricing200Response? model = apiResponse.Ok();
        }
...
## Api Information
- appName: AI Stats Gateway API
- appVersion: 1.0.0
- appDescription: A gateway API for accessing various AI models with OpenAI-compatible endpoints.
