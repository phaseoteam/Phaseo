...
import {
    ...
    AnthropicMessagesStreamEventFromJSON,
    AnthropicMessagesStreamEventToJSON,
    ...
    ChatCompletionsStreamEventFromJSON,
    ChatCompletionsStreamEventToJSON,
    ...
    ResponsesStreamEventFromJSON,
    ResponsesStreamEventToJSON,
...
export class DefaultApi extends runtime.BaseAPI {
    ...
    async createImageEditRaw(requestParameters: CreateImageEditRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ImagesEditResponse>> {
        ...
        if (requestParameters['debug'] != null) {
            formParams.append('debug', new Blob([JSON.stringify(DebugOptionsToJSON(requestParameters['debug']))], { type: "application/json", }));
                    }
