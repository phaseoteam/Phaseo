...
class AnthropicMessagesRequest(TypedDict):
	...
	imageConfig: NotRequired[Dict[str, Any]]
	...
	response_modalities: NotRequired[List[str]]
	responseModalities: NotRequired[List[str]]
...
class ImageConfig(TypedDict):
	...
	fontInputs: NotRequired[List[Dict[str, Any]]]
	image_size: NotRequired[Literal["0.5K", "1K", "2K", "4K"]]
	imageSize: NotRequired[Literal["0.5K", "1K", "2K", "4K"]]
	include_rai_reason: NotRequired[bool]
	includeRaiReason: NotRequired[bool]
	reference_images: NotRequired[List[Dict[str, Any]]]
	referenceImages: NotRequired[List[Dict[str, Any]]]
	super_resolution_references: NotRequired[List[str]]
	superResolutionReferences: NotRequired[List[str]]
...
class ReasoningConfig(TypedDict):
	...
	includeThoughts: NotRequired[bool]
	max_tokens: NotRequired[int]
...
class ResponsesInputItem(TypedDict):
	...
	phase: NotRequired[Optional[Literal["commentary", "final_answer"]]]
...
class ResponsesRequest(TypedDict):
	...
	providerOptions: NotRequired[Dict[str, Any]]
	reasoning: NotRequired[Dict[str, Any]]
	response_modalities: NotRequired[List[str]]
	responseModalities: NotRequired[List[str]]
...
class ThinkingConfig(TypedDict):
	...
	type: NotRequired[Literal["enabled", "disabled", "adaptive"]]
