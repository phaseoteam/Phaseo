...
class MistralOcrOptions(TypedDict):
	bbox_annotation_format: NotRequired[Optional[Union[str, Dict[str, Any]]]]
	confidence_scores_granularity: NotRequired[Optional[Literal["word", "page"]]]
	document_annotation_format: NotRequired[Optional[Union[str, Dict[str, Any]]]]
	document_annotation_prompt: NotRequired[Optional[str]]
	extract_footer: NotRequired[bool]
	extract_header: NotRequired[bool]
	image_limit: NotRequired[Optional[int]]
	image_min_size: NotRequired[Optional[int]]
	include_blocks: NotRequired[bool]
	include_image_base64: NotRequired[Optional[bool]]
	pages: NotRequired[Optional[Union[str, List[int]]]]
	table_format: NotRequired[Literal["markdown", "html"]]
