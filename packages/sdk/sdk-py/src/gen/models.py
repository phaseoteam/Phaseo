...
class ChatCompletionsRequest(TypedDict):
	...
	provider_options: NotRequired[ProviderOptions]
	reasoning: NotRequired[OpenAIReasoningConfig]
	...
	service_tier: NotRequired[Literal["standard", "default", "fast", "priority", "flex", "batch"]]
	session_id: NotRequired[str]
...
class DecisionChoiceQuestion(TypedDict):
	criteria: Dict[str, Any]
	instructions: Union[str, Dict[str, Any], List[Any]]
	type: Literal["choice"]

DecisionInstructions = Union[str, Dict[str, Any], List[Any]]

class DecisionNoulQuestion(TypedDict):
	criteria: NotRequired[Dict[str, Any]]
	instructions: Union[str, Dict[str, Any], List[Any]]
	type: Literal["noul"]

class DecisionScoreQuestion(TypedDict):
	criteria: List[str]
	instructions: Union[str, Dict[str, Any], List[Any]]
	type: Literal["score"]

class DecisionsRequest(TypedDict):
	debug: NotRequired[DebugOptions]
	echo_upstream_request: NotRequired[bool]
	meta: NotRequired[bool]
	metadata: NotRequired[Dict[str, Any]]
...
class DecisionsResponse(TypedDict):
	answers: NotRequired[OcrResponse]
	meta: NotRequired[OcrResponse]
	model: NotRequired[str]
	request_id: NotRequired[Optional[str]]
	usage: NotRequired[DecisionsUsage]
...
KnownModelId = Literal["ai21/jamba-1.5-large", "ai21/jamba-1.5-mini", "ai21/jamba-large-1.5", "ai21/jamba-mini-1.5", "aion-labs/aion-2.0", "aion-labs/aion-3.0", "aion-labs/aion-3.0-mini", "aion-labs/aion-3.5", "aion-labs/aion-3.5-mini", "aion-labs/aion-rp-llama-3.1-8b", "allenai/molmo-2-8b", "amazon/nova-2-lite", "amazon/nova-lite-1.0", "amazon/nova-micro-1.0", "amazon/nova-premier", "amazon/nova-pro-1.0", "anthropic/claude-3-haiku", "anthropic/claude-3.5-haiku", "anthropic/claude-3.7-sonnet", "anthropic/claude-fable-5", "anthropic/claude-fable-5.1", "anthropic/claude-haiku-4.5", "anthropic/claude-opus-4", "anthropic/claude-opus-4.1", "anthropic/claude-opus-4.5", "anthropic/claude-opus-4.6", "anthropic/claude-opus-4.7", "anthropic/claude-opus-4.8", "anthropic/claude-opus-5", "anthropic/claude-opus-5.5", "anthropic/claude-sonnet-4", "anthropic/claude-sonnet-4.5", "anthropic/claude-sonnet-4.6", "anthropic/claude-sonnet-5", "arcee-ai/trinity-large", "arcee-ai/trinity-large-thinking", "arcee-ai/trinity-mini", "baai/bge-m3", "baai/bge-reranker-v2-m3", "baidu/cobuddy", "baidu/ernie-4.5-0.3b", "baidu/ernie-4.5-21b-a3b", "baidu/ernie-4.5-300b-a47b", "baidu/ernie-4.5-turbo", "baidu/ernie-4.5-vl-28b-a3b", "baidu/ernie-4.5-vl-424b-a47b", "baidu/ernie-5.0", "baidu/ernie-5.1", "baidu/ernie-x1.1", "black-forest-labs/flux-1-dev", "black-forest-labs/flux-1-schnell", "black-forest-labs/flux-1.1-pro", "black-forest-labs/flux-2-dev", "black-forest-labs/flux-2-klein-4b", "black-forest-labs/flux-2-klein-9b", "black-forest-labs/flux-2-max", "black-forest-labs/flux-2-pro", "black-forest-labs/flux-3-video", "bytedance/seed-1.6", "bytedance/seed-1.6-2025-06-15", "bytedance/seed-1.6-2025-09-15", "bytedance/seed-1.6-2025-10-15", "bytedance/seed-1.6-250915", "bytedance/seed-1.6-flash", "bytedance/seed-1.6-flash-2025-06-15", "bytedance/seed-1.6-flash-2025-07-15", "bytedance/seed-1.6-flash-2025-08-28", "bytedance/seed-1.6-flash-250715", "bytedance/seed-1.8", "bytedance/seed-1.8-2025-12-28", "bytedance/seed-2.0-code-preview-2026-02-15", "bytedance/seed-2.0-lite", "bytedance/seed-2.0-lite-2026-04-28", "bytedance/seed-2.0-lite-260428", "bytedance/seed-2.0-mini", "bytedance/seed-2.0-mini-2026-04-28", "bytedance/seed-2.0-mini-260428", "bytedance/seed-2.0-pro", "bytedance/seed-2.1-turbo", "bytedance/seed-oss-36b-instruct", "bytedance/seed-translation", "bytedance/seedance-1.5-pro", "bytedance/seedance-2.0", "bytedance/seedance-2.0-fast", "bytedance/seedance-2.0-mini-260615", "bytedance/seedream-5.0-pro", "bytedance/ui-tars-1.5-7b", "cohere/command-a", "cohere/command-r", "cohere/command-r-7b", "cohere/command-r-plus", "cohere/command-r7b", "cohere/embed-english-v3", "cohere/embed-multilingual-v3", "cohere/embed-v4", "cohere/parse-v5.0", "cohere/rerank-v3.5", "cohere/rerank-v4.0-fast", "cohere/rerank-v4.0-pro", "crofai/greg-1-mini", "crofai/greg-2-super", "crofai/greg-2-ultra", "crofai/greg-rp", "deepseek/deepseek-ocr", "deepseek/deepseek-ocr-2", "deepseek/deepseek-r1", "deepseek/deepseek-r1-0528", "deepseek/deepseek-r1-2025-05-28", "deepseek/deepseek-r1-distill-llama-70b", "deepseek/deepseek-r1-turbo", "deepseek/deepseek-v3", "deepseek/deepseek-v3-0324", "deepseek/deepseek-v3-2025-03-24", "deepseek/deepseek-v3-turbo", "deepseek/deepseek-v3.1", "deepseek/deepseek-v3.1-terminus", "deepseek/deepseek-v3.2", "deepseek/deepseek-v3.2-exp", "deepseek/deepseek-v4-flash", "deepseek/deepseek-v4-flash-0731", "deepseek/deepseek-v4-flash-vision-exp", "deepseek/deepseek-v4-pro", "deepseek/deepseek-v4-pro-0813", "deepseek/deepseek-v4.1-flash", "deepseek/deepseek-v4.1-flash-preview", "early-access/ea-29b-a4b", "eleven-labs/eleven-flash-v2", "eleven-labs/eleven-flash-v2.5", "eleven-labs/eleven-multilingual-v2", "eleven-labs/eleven-turbo-v2", "eleven-labs/eleven-turbo-v2.5", "eleven-labs/eleven-v3", "eleven-labs/music", "eleven-labs/scribe-v2", "essential-ai/rnj-1", "fireworks/ember-1", "google/embeddinggemma-300m", "google/gemini-2.5-flash", "google/gemini-2.5-flash-lite", "google/gemini-2.5-pro", "google/gemini-3-flash-preview", "google/gemini-3-pro-image", "google/gemini-3.1-flash-image", "google/gemini-3.1-flash-lite", "google/gemini-3.1-flash-lite-image", "google/gemini-3.1-flash-live-preview", "google/gemini-3.1-flash-tts-preview", "google/gemini-3.1-pro-preview", "google/gemini-3.1-pro-preview-customtools", "google/gemini-3.5-flash", "google/gemini-3.5-flash-lite", "google/gemini-3.5-transcribe", "google/gemini-3.6-flash", "google/gemini-3.7-flash", "google/gemini-3.8-flash", "google/gemini-3.8-flash-lite-tts", "google/gemini-3.8-flash-tts", "google/gemini-3.8-live", "google/gemini-3.8-live-extended-thinking", "google/gemini-embedding-001", "google/gemini-embedding-2", "google/gemini-robotics-er-2-preview", "google/gemma-3-12b", "google/gemma-3-27b", "google/gemma-3-27b-it", "google/gemma-3-4b", "google/gemma-4-12b", "google/gemma-4-26b-a4b", "google/gemma-4-26b-a4b-it", "google/gemma-4-26b-a4b:free", "google/gemma-4-31b", "google/gemma-4-31b-it", "google/gemma-4-31b:free", "google/imagen-4.0-preview", "google/lyria-3-clip-preview", "google/lyria-3-pro-preview", "google/veo-3.1", "google/veo-3.1-fast", "google/veo-3.1-fast-preview", "google/veo-3.1-lite-preview", "google/veo-3.1-preview", "hexgrad/kokoro-82m", "ibm/granite-4.1-8b", "ibm/granite-4.2-30b", "ibm/granite-4.2-3b", "ibm/granite-4.2-8b", "inception/mercury-2", "inception/mercury-2.5", "inception/mercury-edit-2", "inclusionai/ling-2.6-1t", "inclusionai/ling-2.6-flash", "inclusionai/ling-3.0-flash", "inclusionai/ling-3.0-flash-fin:free", "inclusionai/ling-3.0-flash-sante:free", "inclusionai/ling-3.0-flash-vl", "inclusionai/ling-flash-2.0", "inclusionai/ring-2.6-1t", "inclusionai/ring-flash-2.0", "inflection/inflection-3-pi", "inflection/inflection-3-productivity", "jetbrains/mellum2-12b-a2.5b", "kwaipilot/kat-coder-air-v2.5", "kwaipilot/kat-coder-pro", "kwaipilot/kat-coder-pro-v2", "kwaipilot/kat-coder-pro-v2.5", "lightricks/ltx-2.3-fast", "lightricks/ltx-2.3-pro", "lightricks/ltx-2.5-fast", "lightricks/ltx-2.5-pro", "liquid-ai/lfm-2-24b-a2b", "liquid-ai/lfm-2.5-8b-a1b", "ltx-2-3-fast", "ltx-2-3-pro", "ltx-2-5-fast", "ltx-2-5-pro", "medaibase/antangelmed", "meituan/longcat-2.0", "meituan/longcat-flash-lite", "meta/llama-3.1-70b", "meta/llama-3.1-8b", "meta/llama-3.2-3b", "meta/llama-3.3-70b", "meta/llama-3.3-70b-instruct", "meta/llama-4-maverick", "meta/llama-4-scout", "meta/llama-guard-4-12b", "meta/llama-prompt-guard-2-22m", "meta/llama-prompt-guard-2-86m", "meta/muse-glimmer-30b", "meta/muse-image-1.0", "meta/muse-spark-1.2", "meta/muse-spark-1.3", "meta/muse-voice-transcribe-1.0", "microsoft/phi-4", "microsoft/wizardlm-2-8x22b", "mindai/macaron-v1-tall", "mindai/macaron-v1-venti", "minimax/h3", "minimax/hailuo-02", "minimax/hailuo-2.3", "minimax/hailuo-2.3-fast", "minimax/image-01", "minimax/m2-her", "minimax/minimax-m1-80k", "minimax/minimax-m2", "minimax/minimax-m2-her", "minimax/minimax-m2.1", "minimax/minimax-m2.5", "minimax/minimax-m2.5-highspeed", "minimax/minimax-m2.7", "minimax/minimax-m3", "minimax/music-3.0", "minimax/speech-2.6-hd", "minimax/speech-2.6-turbo", "minimax/speech-2.8-hd", "minimax/speech-2.8-turbo", "mistral/codestral", "mistral/codestral-embed", "mistral/devstral-2", "mistral/devstral-2.0", "mistral/leanstral-1.5:free", "mistral/magistral-small-1.2", "mistral/ministral-3-14b", "mistral/ministral-3-3b", "mistral/ministral-3-8b", "mistral/ministral-3.0-14b", "mistral/ministral-3.0-3b", "mistral/ministral-3.0-8b", "mistral/mistral-embed", "mistral/mistral-large-2.0", "mistral/mistral-large-3", "mistral/mistral-large-3.0", "mistral/mistral-medium-3.5", "mistral/mistral-moderation-2", "mistral/mistral-nemo", "mistral/mistral-nemo-2407", "mistral/mistral-small-24b-2501", "mistral/mistral-small-3.2", "mistral/mistral-small-3.2-24b-instruct", "mistral/mistral-small-4", "mistral/ocr-3", "mistral/ocr-4", "mistral/ocr-4.1", "mistral/voxtral-mini", "mistral/voxtral-mini-transcribe-2", "mistral/voxtral-small", "moonshotai/kimi-k2", "moonshotai/kimi-k2-0905", "moonshotai/kimi-k2-2025-07-11", "moonshotai/kimi-k2-thinking", "moonshotai/kimi-k2.5", "moonshotai/kimi-k2.6", "moonshotai/kimi-k2.7-code", "moonshotai/kimi-k2.7-code-highspeed", "moonshotai/kimi-k3", "moonshotai/kimi-k3-fast", "morph/morph-compactor", "morph/morph-v3-fast", "morph/morph-v3-large", "morph/morph-warp-grep-v2.1", "nex-agi/deepseek-v3.1-nex-n1", "nous/hermes-3-llama-3.1-405b", "nous/hermes-3-llama-3.1-70b", "nous/hermes-4-405b", "nousresearch/hermes-3-llama-3.1-70b", "nousresearch/hermes-4-405b", "nvidia/nemotron-3-nano-30b-a3b", "nvidia/nemotron-3-super-120b-a12b", "nvidia/nemotron-3-ultra-550b-a55b", "nvidia/nemotron-3.5-lightning", "nvidia/nemotron-nano-12b-v2-vl", "nvidia/nemotron-nano-9b-v2", "nvidia/nvidia-nemotron-3-nano-30b-a3b", "nvidia/nvidia-nemotron-nano-12b-v2-vl", "nvidia/riva-tts-de-de", "nvidia/riva-tts-en-us", "nvidia/riva-tts-es-es", "nvidia/riva-tts-it-it", "openai/babbage-002", "openai/davinci-002", "openai/gpt-3.5-turbo-0613", "openai/gpt-3.5-turbo-16k", "openai/gpt-3.5-turbo-2023-03-21", "openai/gpt-3.5-turbo-2023-11-06", "openai/gpt-4", "openai/gpt-4-2023-06-13", "openai/gpt-4.1", "openai/gpt-4.1-mini", "openai/gpt-4.1-nano", "openai/gpt-4o", "openai/gpt-4o-2024-05-13", "openai/gpt-4o-2024-08-06", "openai/gpt-4o-2024-11-20", "openai/gpt-4o-mini", "openai/gpt-4o-mini-transcribe", "openai/gpt-4o-mini-tts", "openai/gpt-4o-transcribe", "openai/gpt-5", "openai/gpt-5-mini", "openai/gpt-5-nano", "openai/gpt-5-pro", "openai/gpt-5.1", "openai/gpt-5.2", "openai/gpt-5.2-pro", "openai/gpt-5.3-codex", "openai/gpt-5.4", "openai/gpt-5.4-mini", "openai/gpt-5.4-nano", "openai/gpt-5.4-pro", "openai/gpt-5.5", "openai/gpt-5.5-pro", "openai/gpt-5.6-luna", "openai/gpt-5.6-luna-pro", "openai/gpt-5.6-sol", "openai/gpt-5.6-sol-pro", "openai/gpt-5.6-terra", "openai/gpt-5.6-terra-pro", "openai/gpt-6-astra", "openai/gpt-6-astra-pro", "openai/gpt-6-luna", "openai/gpt-6-luna-pro", "openai/gpt-6-sol", "openai/gpt-6-sol-pro", "openai/gpt-image-1", "openai/gpt-image-1-mini", "openai/gpt-image-1.5", "openai/gpt-image-2", "openai/gpt-image-2.5-flare", "openai/gpt-image-2.5-sunburst", "openai/gpt-oss-120b", "openai/gpt-oss-20b", "openai/gpt-oss-safeguard-120b", "openai/gpt-oss-safeguard-20b", "openai/gpt-realtime", "openai/gpt-realtime-1.5", "openai/gpt-realtime-2", "openai/gpt-realtime-2.1", "openai/gpt-realtime-2.1-mini", "openai/gpt-transcribe", "openai/o1", "openai/o1-mini", "openai/o1-pro", "openai/o3", "openai/o3-mini", "openai/o3-pro", "openai/o4-mini", "openai/omni-moderation", "openai/text-embedding-3-large", "openai/text-embedding-3-small", "openai/text-embedding-ada-002", "openai/whisper-1", "openai/whisper-large-v3", "openai/whisper-large-v3-turbo", "opencompass/compassjudger-1-32b-instruct", "perplexity/pplx-embed-v1-0.6b", "perplexity/pplx-embed-v1-4b", "phaseo/auto", "phaseo/free", "poolside/laguna-m.1:free", "poolside/laguna-s-2.1:free", "poolside/laguna-xs-2.1:free", "qwen/qvq-max", "qwen/qwen-flash", "qwen/qwen-flash-character", "qwen/qwen-image", "qwen/qwen-image-edit", "qwen/qwen-image-edit-2025-10-30", "qwen/qwen-image-edit-2025-12-15", "qwen/qwen-image-edit-max", "qwen/qwen-image-max", "qwen/qwen-image-plus", "qwen/qwen-max", "qwen/qwen-mt-flash", "qwen/qwen-mt-lite", "qwen/qwen-mt-plus", "qwen/qwen-mt-turbo", "qwen/qwen-plus-2025-01-25", "qwen/qwen-plus-2025-04-28", "qwen/qwen-plus-2025-07-14", "qwen/qwen-plus-2025-07-28", "qwen/qwen-plus-2025-09-11", "qwen/qwen-plus-2025-12-01", "qwen/qwen-plus-character", "qwen/qwen-turbo-2024-11-01", "qwen/qwen-turbo-2025-04-28", "qwen/qwen-vl-max-2025-04-08", "qwen/qwen-vl-max-2025-08-13", "qwen/qwen-vl-plus-2025-01-25", "qwen/qwen-vl-plus-2025-05-07", "qwen/qwen-vl-plus-2025-08-15", "qwen/qwen2.5-14b", "qwen/qwen2.5-14b-1m", "qwen/qwen2.5-32b", "qwen/qwen2.5-72b", "qwen/qwen2.5-7b", "qwen/qwen2.5-7b-1m", "qwen/qwen2.5-coder-7b", "qwen/qwen2.5-vl-32b", "qwen/qwen2.5-vl-32b-instruct", "qwen/qwen2.5-vl-72b", "qwen/qwen2.5-vl-72b-instruct", "qwen/qwen2.5-vl-7b", "qwen/qwen3-0.6b", "qwen/qwen3-1.7b", "qwen/qwen3-14b", "qwen/qwen3-235b-a22b", "qwen/qwen3-235b-a22b-2507", "qwen/qwen3-235b-a22b-instruct-2507", "qwen/qwen3-235b-a22b-thinking-2507", "qwen/qwen3-30b-a3b", "qwen/qwen3-30b-a3b-2507", "qwen/qwen3-30b-a3b-instruct-2507", "qwen/qwen3-30b-a3b-thinking-2507", "qwen/qwen3-32b", "qwen/qwen3-4b", "qwen/qwen3-8b", "qwen/qwen3-asr-0.6b", "qwen/qwen3-asr-1.7b", "qwen/qwen3-coder", "qwen/qwen3-coder-30b-a3b", "qwen/qwen3-coder-480b-a35b", "qwen/qwen3-coder-flash", "qwen/qwen3-coder-next", "qwen/qwen3-coder-plus-2025-07-22", "qwen/qwen3-coder-plus-2025-09-23", "qwen/qwen3-embedding-0.6b", "qwen/qwen3-embedding-4b", "qwen/qwen3-embedding-8b", "qwen/qwen3-max", "qwen/qwen3-max-2025-09-23", "qwen/qwen3-max-2026-01-23", "qwen/qwen3-max-preview", "qwen/qwen3-max-thinking", "qwen/qwen3-next-80b", "qwen/qwen3-next-80b-a3b", "qwen/qwen3-next-80b-a3b-instruct", "qwen/qwen3-next-80b-a3b-thinking", "qwen/qwen3-omni-30b-a3b", "qwen/qwen3-omni-30b-a3b-thinking", "qwen/qwen3-reranker", "qwen/qwen3-reranker-0.6b", "qwen/qwen3-reranker-4b", "qwen/qwen3-reranker-8b", "qwen/qwen3-tts", "qwen/qwen3-tts-voicedesign", "qwen/qwen3-vl-235b-a22b", "qwen/qwen3-vl-235b-a22b-instruct", "qwen/qwen3-vl-235b-a22b-thinking", "qwen/qwen3-vl-30b-a3b", "qwen/qwen3-vl-30b-a3b-instruct", "qwen/qwen3-vl-30b-a3b-thinking", "qwen/qwen3-vl-32b-instruct", "qwen/qwen3-vl-32b-thinking", "qwen/qwen3-vl-8b", "qwen/qwen3-vl-8b-instruct", "qwen/qwen3-vl-flash-2025-10-15", "qwen/qwen3-vl-flash-2026-01-22", "qwen/qwen3-vl-plus-2025-09-23", "qwen/qwen3-vl-plus-2025-12-19", "qwen/qwen3.5-122b-a10b", "qwen/qwen3.5-27b", "qwen/qwen3.5-35b-a3b", "qwen/qwen3.5-397b-a17b", "qwen/qwen3.5-4b", "qwen/qwen3.5-9b", "qwen/qwen3.5-flash", "qwen/qwen3.5-livetranslate-flash-realtime-2026-05-19", "qwen/qwen3.5-plus", "qwen/qwen3.5-plus-2026-02-15", "qwen/qwen3.5-plus-2026-04-20", "qwen/qwen3.6-27b", "qwen/qwen3.6-35b-a3b", "qwen/qwen3.6-flash", "qwen/qwen3.6-max-preview", "qwen/qwen3.6-plus", "qwen/qwen3.7-max", "qwen/qwen3.7-max-2026-05-17", "qwen/qwen3.7-plus", "qwen/qwen3.7-plus-2026-05-26", "qwen/qwen3.8-2.4t-a95b", "qwen/qwen3.8-27b", "qwen/qwen3.8-flash", "qwen/qwen3.8-max", "qwen/qwen3.8-max-0902", "qwen/qwq-32b", "qwen/qwq-plus", "qwen/text-embedding-v3", "qwen/text-embedding-v4", "qwen/wan2.7-t2v", "qwen/wan3.0-video", "qwen/wan3.0-video-prime", "reka-edge", "reka-edge-2603", "reka-flash", "reka-flash-research", "reka/reka-edge", "reka/reka-edge-2603", "reka/reka-flash", "relace/relace-rank", "relace/relace-search", "spacex-ai/grok-4.20", "spacex-ai/grok-4.20-multi-agent-beta", "spacex-ai/grok-4.20-multi-agent-beta-0309", "spacex-ai/grok-4.3", "spacex-ai/grok-4.5", "spacex-ai/grok-4.6", "spacex-ai/grok-4.7", "spacex-ai/grok-build-0.1", "spacex-ai/grok-imagine-image", "spacex-ai/grok-imagine-image-2.0", "spacex-ai/grok-imagine-video", "spacex-ai/grok-imagine-video-1.5", "spacex-ai/grok-transcribe", "spacex-ai/grok-tts", "spacex-ai/grok-voice-think-fast-2.0", "spacex-ai/grok-voice-transcribe-2.0", "stability-ai/stable-diffusion-xl-base-1.0", "stealth/space-bunny-alpha", "stepfun/step-1o-audio", "stepfun/step-1o-turbo-vision", "stepfun/step-1x-edit", "stepfun/step-2-16k-exp", "stepfun/step-3.5-flash", "stepfun/step-3.7-flash", "stepfun/step-asr", "stepfun/step-asr-1.1-stream", "stepfun/step-audio-2", "stepfun/step-audio-r1.1", "stepfun/step-r1-v-mini", "stepfun/step-tts-2", "stepfun/step-tts-mini", "stepfun/stepaudio-2-asr-pro", "stepfun/stepaudio-2.5-asr", "stepfun/stepaudio-2.5-tts", "tencent/hunyuan-a13b-instruct", "tencent/hy3", "tencent/hy3-preview", "tencent/hy3:free", "tencent/hy4-preview", "thedrummer/cydonia-24b-v4.1", "thedrummer/skyfall-36b-v2", "thinking-machines/inkling", "thinking-machines/inkling-small", "together/tev1-4b-experimental", "typesafe/jev-1.13.0", "upstage/document-ocr", "upstage/document-parse", "upstage/solar-embedding-1-large-passage", "upstage/solar-embedding-1-large-query", "upstage/solar-embedding-2-passage", "upstage/solar-embedding-2-query", "upstage/solar-mini", "upstage/solar-mini-4", "upstage/solar-pro-2", "upstage/solar-pro-3", "upstage/solar-pro-4", "venice/gemma-4-uncensored", "venice/venice-role-play-uncensored", "venice/venice-uncensored-1.2", "voyage/rerank-1", "voyage/rerank-2", "voyage/rerank-2-lite", "voyage/rerank-2.5", "voyage/rerank-2.5-lite", "voyage/rerank-lite-1", "voyage/voyage-01", "voyage/voyage-02", "voyage/voyage-2", "voyage/voyage-3", "voyage/voyage-3-large", "voyage/voyage-3-lite", "voyage/voyage-3.5", "voyage/voyage-3.5-lite", "voyage/voyage-4", "voyage/voyage-4-large", "voyage/voyage-4-lite", "voyage/voyage-code-2", "voyage/voyage-code-3", "voyage/voyage-code-4", "voyage/voyage-context-3", "voyage/voyage-finance-2", "voyage/voyage-large-2", "voyage/voyage-large-2-instruct", "voyage/voyage-law-2", "voyage/voyage-lite-01", "voyage/voyage-lite-01-instruct", "voyage/voyage-lite-02-instruct", "voyage/voyage-multilingual-2", "voyage/voyage-multimodal-3", "voyage/voyage-multimodal-3.5", "x-ai/grok-voice-think-fast-2.0", "xiaomi/mimo-v2.5", "xiaomi/mimo-v2.5-asr", "xiaomi/mimo-v2.5-pro", "xiaomi/mimo-v2.5-pro-ultraspeed", "xiaomi/mimo-v2.5-tts-voiceclone:free", "xiaomi/mimo-v2.5-tts-voicedesign:free", "xiaomi/mimo-v2.5-tts:free", "xiaomi/mimo-v2.6-flash", "xiaomi/mimo-v2.6-pro", "z-ai/autoglm-phone-9b-multilingual", "z-ai/glm-4-32b", "z-ai/glm-4.5", "z-ai/glm-4.5-air", "z-ai/glm-4.5-air-x", "z-ai/glm-4.5-x", "z-ai/glm-4.5v", "z-ai/glm-4.6", "z-ai/glm-4.6v", "z-ai/glm-4.6v-flash", "z-ai/glm-4.7", "z-ai/glm-4.7-flash", "z-ai/glm-4.7-flash-heretic", "z-ai/glm-5", "z-ai/glm-5-turbo", "z-ai/glm-5.1", "z-ai/glm-5.2", "z-ai/glm-5.3", "z-ai/glm-5.3-flash", "z-ai/glm-5v-turbo", "zai-org/glm-4.5-air", "zai/glm-5"]
...
class OpenAIReasoningConfig(TypedDict):
...
OrganisationId = Literal["01-ai", "adept", "ai21", "aion-labs", "alibaba", "allenai", "amazon", "anthracite-org", "anthropic", "arcee-ai", "baai", "baichuan", "baidu", "bigcode", "black-forest-labs", "bytedance", "bytedance-seed", "cogito", "cognitivecomputations", "cohere", "crofai", "cursor", "cyfragovpl", "databricks", "decart", "deepseek", "dots-studio", "early-access", "eleven-labs", "essential-ai", "fastino", "fireworks", "fish-audio", "github", "google", "gryphe", "hexgrad", "ibm", "ibm-granite", "inception", "inclusionai", "inference-net", "inflection", "intfloat", "jetbrains", "kblab", "kling", "kuaishou", "kwaipilot", "kwaivgi", "lg", "lightricks", "liquid-ai", "mancer", "medaibase", "meituan", "meta", "microsoft", "mindai", "minimax", "mistral", "mistralai", "moonshotai", "morph", "naver-hyperclova", "near-ai", "nex-agi", "nous", "nousresearch", "novasearch", "nvidia", "openai", "openbmb", "opencompass", "opengvlab", "orcarouter", "ornith", "perceptron", "perplexity", "phala", "pixverse", "poe", "poolside", "prime-intellect", "prism-ml", "qwen", "reka", "relace", "runway", "sakana", "sao10k", "sapiens-ai", "sentence-transformers", "sference", "shanghai-ai-laboratory", "shengshu-ai", "sourceful", "spacex-ai", "speakleash", "stability-ai", "stealth", "stepfun", "suno", "tencent", "thedrummer", "thinking-machines", "together", "typesafe", "unbiased", "undi95", "upstage", "venice", "vercel", "villanova-ai", "voyage", "windsurf", "writer", "xai", "xgenerationlab", "xiaomi", "z-ai"]

OrganisationIdList = List[Literal["01-ai", "adept", "ai21", "aion-labs", "alibaba", "allenai", "amazon", "anthracite-org", "anthropic", "arcee-ai", "baai", "baichuan", "baidu", "bigcode", "black-forest-labs", "bytedance", "bytedance-seed", "cogito", "cognitivecomputations", "cohere", "crofai", "cursor", "cyfragovpl", "databricks", "decart", "deepseek", "dots-studio", "early-access", "eleven-labs", "essential-ai", "fastino", "fireworks", "fish-audio", "github", "google", "gryphe", "hexgrad", "ibm", "ibm-granite", "inception", "inclusionai", "inference-net", "inflection", "intfloat", "jetbrains", "kblab", "kling", "kuaishou", "kwaipilot", "kwaivgi", "lg", "lightricks", "liquid-ai", "mancer", "medaibase", "meituan", "meta", "microsoft", "mindai", "minimax", "mistral", "mistralai", "moonshotai", "morph", "naver-hyperclova", "near-ai", "nex-agi", "nous", "nousresearch", "novasearch", "nvidia", "openai", "openbmb", "opencompass", "opengvlab", "orcarouter", "ornith", "perceptron", "perplexity", "phala", "pixverse", "poe", "poolside", "prime-intellect", "prism-ml", "qwen", "reka", "relace", "runway", "sakana", "sao10k", "sapiens-ai", "sentence-transformers", "sference", "shanghai-ai-laboratory", "shengshu-ai", "sourceful", "spacex-ai", "speakleash", "stability-ai", "stealth", "stepfun", "suno", "tencent", "thedrummer", "thinking-machines", "together", "typesafe", "unbiased", "undi95", "upstage", "venice", "vercel", "villanova-ai", "voyage", "windsurf", "writer", "xai", "xgenerationlab", "xiaomi", "z-ai"]]
...
SystemOneInstructions = Union[str, Dict[str, Any], List[Any]]
...
class WebhookEndpoint(TypedDict):
	...
	events: List[Literal["job.created", "job.status_changed", "job.progress", "job.completed", "job.failed", "job.cancelled", "job.expired", "video.created", "video.status_changed", "video.progress", "video.completed", "video.failed", "video.cancelled", "video.expired", "batch.created", "batch.status_changed", "batch.progress", "batch.completed", "batch.failed", "batch.cancelled", "batch.expired"]]
	hasSecret: bool
	id: str
	name: str
...
class WebhookEndpointCreateRequest(TypedDict):
	events: NotRequired[List[Literal["job.created", "job.status_changed", "job.progress", "job.completed", "job.failed", "job.cancelled", "job.expired", "video.created", "video.status_changed", "video.progress", "video.completed", "video.failed", "video.cancelled", "video.expired", "batch.created", "batch.status_changed", "batch.progress", "batch.completed", "batch.failed", "batch.cancelled", "batch.expired"]]]
	name: NotRequired[str]
	url: str
...
WebhookEndpointEvent = Literal["job.created", "job.status_changed", "job.progress", "job.completed", "job.failed", "job.cancelled", "job.expired", "video.created", "video.status_changed", "video.progress", "video.completed", "video.failed", "video.cancelled", "video.expired", "batch.created", "batch.status_changed", "batch.progress", "batch.completed", "batch.failed", "batch.cancelled", "batch.expired"]
...
class WebhookEndpointTestResponse(TypedDict):
	error: Optional[str]
	event_id: str
	ok: bool
