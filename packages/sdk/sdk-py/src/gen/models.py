...
class AsyncJobWebSocketServerEvent(TypedDict):
	data: NotRequired[Optional[Union[Dict[str, Any], Dict[str, Any], Dict[str, Any]]]]
...
class BatchModelCapability(TypedDict):
	...
	supported_parameters_detail: NotRequired[Dict[str, Any]]
	supported_params: NotRequired[List[str]]
	supported_params_detail: NotRequired[Dict[str, Any]]
...
class ChatCompletionsRequest(TypedDict):
	...
	service_tier: NotRequired[Literal["standard", "priority", "flex", "batch"]]
	session_id: NotRequired[str]
...
class InteractionContentBlock(TypedDict):
...
class InteractionResponse(TypedDict):
	...
	id: str
	model: str
	object: Literal["interaction"]
	output_text: NotRequired[str]
	status: Literal["completed", "failed", "incomplete", "requires_action"]
	steps: List[Dict[str, Any]]
	usage: NotRequired[Dict[str, Any]]

class InteractionsRequest(TypedDict):
	background: NotRequired[bool]
	cached_content: NotRequired[str]
	debug: NotRequired[Dict[str, Any]]
	echo_upstream_request: NotRequired[bool]
	environment: NotRequired[Union[str, Dict[str, Any]]]
	generation_config: NotRequired[Dict[str, Any]]
	input: Union[str, List[Union[Dict[str, Any], Dict[str, Any], Dict[str, Any]]], Dict[str, Any]]
	...
	provider: NotRequired[Dict[str, Any]]
	response_format: NotRequired[Union[Dict[str, Any], List[Dict[str, Any]]]]
	response_modalities: NotRequired[Literal["text", "image", "audio", "video", "document"]]
	safety_settings: NotRequired[List[Dict[str, Any]]]
	service_tier: NotRequired[Literal["standard", "priority", "flex"]]
	session_id: NotRequired[str]
	store: NotRequired[bool]
	stream: NotRequired[bool]
...
class InteractionStep(TypedDict):
	arguments: NotRequired[Union[str, Dict[str, Any]]]
	...
	summary: NotRequired[Union[str, Dict[str, Any]]]
	type: Literal["user_input", "model_output", "thought", "function_call", "function_result"]
...
KnownModelId = Literal["ai21/jamba-large-1.7", "ai21/jamba-mini-2", "aion-labs/aion-2.0", "aion-labs/aion-2.5", "aion-labs/aion-3.0", "aion-labs/aion-3.0-mini", "aion-labs/aion-rp-llama-3.1-8b", "allenai/molmo-2-8b", "allenai/olmo-3.1-32b", "anthropic/claude-fable-5", "anthropic/claude-haiku-4.5", "anthropic/claude-opus-4.1", "anthropic/claude-opus-4.5", "anthropic/claude-opus-4.6", "anthropic/claude-opus-4.7", "anthropic/claude-opus-4.7-fast", "anthropic/claude-opus-4.8", "anthropic/claude-sonnet-4.5", "anthropic/claude-sonnet-4.6", "anthropic/claude-sonnet-5", "arcee-ai/trinity-large", "arcee-ai/trinity-large-thinking", "arcee-ai/trinity-mini", "baidu/ernie-4.5-21b-a3b", "baidu/ernie-4.5-21b-a3b-thinking", "baidu/ernie-4.5-300b-a47b", "baidu/ernie-4.5-vl-28b-a3b", "baidu/ernie-4.5-vl-28b-a3b-thinking", "baidu/ernie-4.5-vl-424b-a47b", "black-forest-labs/flux-1-schnell", "bytedance/seed-1.6", "bytedance/seed-1.6-250915", "bytedance/seed-1.6-flash", "bytedance/seed-1.6-flash-250715", "bytedance/seed-1.8", "bytedance/seed-2.0-lite", "bytedance/seed-2.0-lite-260428", "bytedance/seed-2.0-mini", "bytedance/seed-2.0-mini-260428", "bytedance/seed-2.0-pro", "bytedance/seed-oss-36b-instruct", "bytedance/seed-translation", "bytedance/seedance-2.0", "bytedance/seedance-2.0-fast", "bytedance/seedance-2.0-mini-260615", "crofai/greg-1-mini", "crofai/greg-2-super", "crofai/greg-2-ultra", "crofai/greg-rp", "deepseek/deepseek-ocr", "deepseek/deepseek-ocr-2", "deepseek/deepseek-prover-v2-671b", "deepseek/deepseek-r1", "deepseek/deepseek-r1-0528", "deepseek/deepseek-r1-2025-05-28", "deepseek/deepseek-r1-turbo", "deepseek/deepseek-v3", "deepseek/deepseek-v3-0324", "deepseek/deepseek-v3-turbo", "deepseek/deepseek-v3.1", "deepseek/deepseek-v3.1-terminus", "deepseek/deepseek-v3.2", "deepseek/deepseek-v3.2-exp", "deepseek/deepseek-v3.2-speciale", "deepseek/deepseek-v3.2-thinking", "deepseek/deepseek-v4-flash", "deepseek/deepseek-v4-pro", "deepseek/deepseek-v4-pro-lightning", "eleven-labs/eleven-flash-v2", "eleven-labs/eleven-flash-v2.5", "eleven-labs/eleven-multilingual-v2", "eleven-labs/eleven-turbo-v2", "eleven-labs/eleven-turbo-v2.5", "eleven-labs/eleven-v3", "essential-ai/rnj-1", "google/gemini-2.5-flash", "google/gemini-2.5-flash-lite", "google/gemini-2.5-flash-lite-preview-2025-06-17", "google/gemini-2.5-flash-lite-preview-2025-09-25", "google/gemini-2.5-pro", "google/gemini-3-flash-preview", "google/gemini-3-pro-image", "google/gemini-3.1-flash-image", "google/gemini-3.1-flash-image-preview", "google/gemini-3.1-flash-lite", "google/gemini-3.1-flash-lite-image", "google/gemini-3.1-flash-lite-preview", "google/gemini-3.1-flash-tts-preview", "google/gemini-3.1-pro-preview", "google/gemini-3.1-pro-preview-customtools", "google/gemini-3.5-flash", "google/gemini-3.5-pro", "google/gemini-embedding-001", "google/gemini-embedding-2", "google/gemini-embedding-2-preview", "google/gemini-robotics-er-1.6-preview", "google/gemma-3-27b", "google/gemma-3n-e4b", "google/gemma-4-26b-a4b", "google/gemma-4-26b-a4b:free", "google/gemma-4-31b", "google/gemma-4-31b-it", "google/gemma-4-31b:free", "google/lyria-3-clip-preview", "google/lyria-3-pro-preview", "google/veo-2", "google/veo-3.1-fast-preview", "google/veo-3.1-lite-generate-preview", "google/veo-3.1-preview", "ibm/granite-4.1-8b", "inception/mercury-2", "inception/mercury-edit-2", "inclusionai/ling-2.6-1t", "inclusionai/ling-flash-2.0", "inclusionai/ring-flash-2.0", "inflection/inflection-3-pi", "inflection/inflection-3-productivity", "kwaipilot/kat-coder-air-v2.5", "kwaipilot/kat-coder-exp-72b-1010", "kwaipilot/kat-coder-pro", "kwaipilot/kat-coder-pro-v1", "kwaipilot/kat-coder-pro-v2", "kwaipilot/kat-coder-pro-v2.5", "liquid-ai/lfm-2-24b-a2b", "meituan/longcat-2.0", "meta/llama-3-70b", "meta/llama-3-8b", "meta/llama-3-8b-lite", "meta/llama-3.1-70b", "meta/llama-3.1-8b", "meta/llama-3.2-11b-vision", "meta/llama-3.2-3b", "meta/llama-3.3-70b", "meta/llama-4-maverick", "meta/llama-4-scout", "meta/llama-guard-4-12b", "meta/llama-prompt-guard-2-22m", "meta/llama-prompt-guard-2-86m", "microsoft/phi-4", "microsoft/phi-4-mini", "minimax/hailuo-02", "minimax/hailuo-2.3", "minimax/hailuo-2.3-fast", "minimax/m2-her", "minimax/minimax-m1-80k", "minimax/minimax-m2", "minimax/minimax-m2.1", "minimax/minimax-m2.5", "minimax/minimax-m2.5-highspeed", "minimax/minimax-m2.7", "minimax/minimax-m3", "minimax/music-2.6", "minimax/music-2.6-free", "mistral/codestral-embed", "mistral/devstral-2", "mistral/devstral-medium-1.0", "mistral/devstral-small-1.1", "mistral/leanstral-1.5:free", "mistral/magistral-medium-1.2", "mistral/ministral-3-14b", "mistral/ministral-3-3b", "mistral/ministral-3-8b", "mistral/mistral-embed", "mistral/mistral-large-2.1", "mistral/mistral-large-3", "mistral/mistral-medium-3.0", "mistral/mistral-medium-3.1", "mistral/mistral-medium-3.5", "mistral/mistral-moderation", "mistral/mistral-moderation-2", "mistral/mistral-nemo-12b", "mistral/mistral-nemo-2407", "mistral/mistral-small-24b-2501", "mistral/mistral-small-3.2", "mistral/mistral-small-4", "mistral/mixtral-8x7b", "mistral/pixtral-large", "mistralai/mistral-nemo", "moonshotai/kimi-k2", "moonshotai/kimi-k2-0905", "moonshotai/kimi-k2-instruct", "moonshotai/kimi-k2-instruct-0905", "moonshotai/kimi-k2-thinking", "moonshotai/kimi-k2.5", "moonshotai/kimi-k2.5-lightning", "moonshotai/kimi-k2.6", "moonshotai/kimi-k2.7-code", "moonshotai/moonshot-v1-128k", "moonshotai/moonshot-v1-128k-vision-preview", "moonshotai/moonshot-v1-32k", "moonshotai/moonshot-v1-32k-vision-preview", "moonshotai/moonshot-v1-8k", "moonshotai/moonshot-v1-8k-vision-preview", "morph/morph-v3-fast", "morph/morph-v3-large", "nex-agi/deepseek-v3.1-nex-n1", "nex-agi/nex-n2-pro", "nous/hermes-3-llama-3.1-405b", "nousresearch/hermes-3-llama-3.1-405b", "nousresearch/hermes-3-llama-3.1-70b", "nousresearch/hermes-4-405b", "nousresearch/hermes-4-70b", "nvidia/cosmos3-super-reasoner", "nvidia/llama-3.1-nemotron-70b-instruct", "nvidia/llama-3.1-nemotron-ultra-253b", "nvidia/llama-3.3-nemotron-super-49b-v1.5", "nvidia/nemotron-3-nano-30b-a3b", "nvidia/nemotron-3-nano-omni-30b-a3b-reasoning", "nvidia/nemotron-3-super-120b-a12b", "nvidia/nemotron-3-ultra-550b-a55b", "nvidia/nvidia-nemotron-3-nano-30b-a3b", "nvidia/nvidia-nemotron-nano-12b-v2-vl", "openai/babbage-002", "openai/chat-latest", "openai/chatgpt-4o", "openai/computer-use-preview", "openai/davinci-002", "openai/gpt-3.5-turbo-16k", "openai/gpt-3.5-turbo-2023-03-21", "openai/gpt-4-2023-06-13", "openai/gpt-4-turbo-2023-03-14", "openai/gpt-4-turbo-2023-11-06", "openai/gpt-4-turbo-2024-01-25", "openai/gpt-4.1", "openai/gpt-4.1-mini", "openai/gpt-4.1-nano", "openai/gpt-4o-2024-05-13", "openai/gpt-4o-2024-08-06", "openai/gpt-4o-2024-11-20", "openai/gpt-4o-mini", "openai/gpt-4o-mini-transcribe", "openai/gpt-4o-mini-tts", "openai/gpt-4o-transcribe", "openai/gpt-5", "openai/gpt-5-chat", "openai/gpt-5-codex", "openai/gpt-5-mini", "openai/gpt-5-nano", "openai/gpt-5-pro", "openai/gpt-5.1", "openai/gpt-5.1-chat", "openai/gpt-5.1-codex", "openai/gpt-5.1-codex-max", "openai/gpt-5.1-codex-mini", "openai/gpt-5.2", "openai/gpt-5.2-chat", "openai/gpt-5.2-codex", "openai/gpt-5.2-pro", "openai/gpt-5.3-chat", "openai/gpt-5.3-codex", "openai/gpt-5.4", "openai/gpt-5.4-mini", "openai/gpt-5.4-nano", "openai/gpt-5.4-pro", "openai/gpt-5.5", "openai/gpt-5.5-pro", "openai/gpt-5.6-luna", "openai/gpt-5.6-luna-pro", "openai/gpt-5.6-sol", "openai/gpt-5.6-sol-pro", "openai/gpt-5.6-terra", "openai/gpt-5.6-terra-pro", "openai/gpt-image-1", "openai/gpt-image-1-mini", "openai/gpt-image-1.5", "openai/gpt-image-2", "openai/gpt-oss-120b", "openai/gpt-oss-20b", "openai/gpt-oss-safeguard-20b", "openai/o1", "openai/o1-mini", "openai/o1-pro", "openai/o3", "openai/o3-deep-research", "openai/o3-mini", "openai/o3-pro", "openai/o4-mini", "openai/o4-mini-deep-research", "openai/omni-moderation", "openai/sora-2", "openai/sora-2-pro", "openai/text-embedding-3-large", "openai/text-embedding-3-small", "openai/text-embedding-ada-002", "openai/whisper-1", "phaseo/free", "poolside/laguna-m.1:free", "poolside/laguna-xs-2.1:free", "qwen/qvq-max", "qwen/qwen-3.6-plus", "qwen/qwen-flash", "qwen/qwen-flash-character", "qwen/qwen-max", "qwen/qwen-mt-flash", "qwen/qwen-mt-lite", "qwen/qwen-mt-plus", "qwen/qwen-mt-turbo", "qwen/qwen-plus-2025-01-25", "qwen/qwen-plus-2025-04-28", "qwen/qwen-plus-2025-07-14", "qwen/qwen-plus-2025-07-28", "qwen/qwen-plus-2025-09-11", "qwen/qwen-plus-2025-12-01", "qwen/qwen-plus-character", "qwen/qwen-turbo-2024-11-01", "qwen/qwen-turbo-2025-04-28", "qwen/qwen-vl-max-2025-04-08", "qwen/qwen-vl-max-2025-08-13", "qwen/qwen-vl-plus-2025-01-25", "qwen/qwen-vl-plus-2025-05-07", "qwen/qwen-vl-plus-2025-08-15", "qwen/qwen2.5-14b", "qwen/qwen2.5-14b-1m", "qwen/qwen2.5-32b", "qwen/qwen2.5-72b", "qwen/qwen2.5-7b", "qwen/qwen2.5-7b-1m", "qwen/qwen2.5-coder-7b", "qwen/qwen2.5-vl-32b", "qwen/qwen2.5-vl-32b-instruct", "qwen/qwen2.5-vl-72b", "qwen/qwen2.5-vl-72b-instruct", "qwen/qwen2.5-vl-7b", "qwen/qwen3-0.6b", "qwen/qwen3-1.7b", "qwen/qwen3-14b", "qwen/qwen3-235b-a22b-2507", "qwen/qwen3-235b-a22b-instruct-2507", "qwen/qwen3-235b-a22b-thinking-2507", "qwen/qwen3-30b-a3b", "qwen/qwen3-30b-a3b-2507", "qwen/qwen3-30b-a3b-instruct-2507", "qwen/qwen3-30b-a3b-thinking-2507", "qwen/qwen3-32b", "qwen/qwen3-4b", "qwen/qwen3-8b", "qwen/qwen3-coder", "qwen/qwen3-coder-30b-a3b", "qwen/qwen3-coder-480b-a35b", "qwen/qwen3-coder-flash", "qwen/qwen3-coder-next", "qwen/qwen3-coder-plus-2025-07-22", "qwen/qwen3-coder-plus-2025-09-23", "qwen/qwen3-embedding-8b", "qwen/qwen3-max", "qwen/qwen3-max-2025-09-23", "qwen/qwen3-max-2026-01-23", "qwen/qwen3-max-preview", "qwen/qwen3-max-thinking", "qwen/qwen3-next-80b", "qwen/qwen3-next-80b-a3b", "qwen/qwen3-next-80b-a3b-instruct", "qwen/qwen3-next-80b-a3b-thinking", "qwen/qwen3-omni-30b-a3b-thinking", "qwen/qwen3-reranker", "qwen/qwen3-vl-235b-a22b", "qwen/qwen3-vl-235b-a22b-instruct", "qwen/qwen3-vl-235b-a22b-thinking", "qwen/qwen3-vl-30b-a3b", "qwen/qwen3-vl-30b-a3b-instruct", "qwen/qwen3-vl-30b-a3b-thinking", "qwen/qwen3-vl-32b-instruct", "qwen/qwen3-vl-32b-thinking", "qwen/qwen3-vl-8b", "qwen/qwen3-vl-8b-instruct", "qwen/qwen3-vl-flash-2025-10-15", "qwen/qwen3-vl-flash-2026-01-22", "qwen/qwen3-vl-plus-2025-09-23", "qwen/qwen3-vl-plus-2025-12-19", "qwen/qwen3.5-122b-a10b", "qwen/qwen3.5-27b", "qwen/qwen3.5-35b-a3b", "qwen/qwen3.5-397b-a17b", "qwen/qwen3.5-4b", "qwen/qwen3.5-9b", "qwen/qwen3.5-flash", "qwen/qwen3.5-livetranslate-flash-realtime-2026-05-19", "qwen/qwen3.5-plus", "qwen/qwen3.5-plus-2026-04-20", "qwen/qwen3.6-27b", "qwen/qwen3.6-35b-a3b", "qwen/qwen3.6-max-preview", "qwen/qwen3.6-plus", "qwen/qwen3.7-max", "qwen/qwen3.7-max-2026-05-17", "qwen/qwen3.7-plus", "qwen/qwen3.7-plus-2026-05-26", "qwen/qwq-32b", "qwen/qwq-plus", "qwen/text-embedding-v3", "qwen/text-embedding-v4", "qwen/wan2.7-t2v", "spacex-ai/grok-4.20-beta-0309", "spacex-ai/grok-4.20-multi-agent-beta-0309", "spacex-ai/grok-4.3", "spacex-ai/grok-4.5", "spacex-ai/grok-build-0.1", "spacex-ai/grok-code-fast-1", "spacex-ai/grok-imagine-image", "spacex-ai/grok-imagine-image-quality", "spacex-ai/grok-imagine-video", "spacex-ai/grok-tts", "stepfun/step-3.5-flash", "stepfun/step-3.7-flash", "tencent/hunyuan-a13b-instruct", "tencent/hy3", "tencent/hy3-preview", "tencent/hy3:free", "thinking-machines/inkling", "thinking-machines/inkling-64k", "venice/venice-uncensored", "venice/venice-uncensored-1.1", "voyage/rerank-1", "voyage/rerank-2", "voyage/rerank-2-lite", "voyage/rerank-lite-1", "voyage/voyage-01", "voyage/voyage-02", "voyage/voyage-2", "voyage/voyage-3", "voyage/voyage-3-large", "voyage/voyage-3-lite", "voyage/voyage-3.5", "voyage/voyage-3.5-lite", "voyage/voyage-4", "voyage/voyage-4-large", "voyage/voyage-4-lite", "voyage/voyage-code-2", "voyage/voyage-code-3", "voyage/voyage-context-3", "voyage/voyage-finance-2", "voyage/voyage-large-2", "voyage/voyage-large-2-instruct", "voyage/voyage-law-2", "voyage/voyage-lite-01", "voyage/voyage-lite-01-instruct", "voyage/voyage-lite-02-instruct", "voyage/voyage-multilingual-2", "voyage/voyage-multimodal-3", "voyage/voyage-multimodal-3.5", "xiaomi/mimo-v2-flash", "xiaomi/mimo-v2.5", "xiaomi/mimo-v2.5-pro", "xiaomi/mimo-v2.5-tts:free", "z-ai/glm-4-32b", "z-ai/glm-4-7-flash:free", "z-ai/glm-4.5", "z-ai/glm-4.5-air", "z-ai/glm-4.5-air-x", "z-ai/glm-4.5-x", "z-ai/glm-4.5v", "z-ai/glm-4.6", "z-ai/glm-4.6v", "z-ai/glm-4.6v-flash", "z-ai/glm-4.7", "z-ai/glm-4.7-flash", "z-ai/glm-5", "z-ai/glm-5-code", "z-ai/glm-5-turbo", "z-ai/glm-5.1", "z-ai/glm-5.2", "z-ai/glm-5v-turbo", "zai-org/glm-4.5-air", "zai/glm-5"]
...
class ModelProviderAvailability(TypedDict):
	...
	params: List[str]
	params_detail: NotRequired[Dict[str, Any]]
...
OrganisationId = Literal["ai21", "aion-labs", "allenai", "amazon", "anthropic", "arcee-ai", "baidu", "black-forest-labs", "bytedance", "cohere", "cursor", "deepseek", "eleven-labs", "essential-ai", "github", "google", "ibm", "inception", "inclusionai", "kwaipilot", "lg", "liquid-ai", "meituan", "meta", "microsoft", "minimax", "mistral", "moonshotai", "naver-hyperclova", "nex-agi", "nous", "nvidia", "openai", "perplexity", "poe", "poolside", "prime-intellect", "qwen", "relace", "sourceful", "spacex-ai", "stepfun", "suno", "tencent", "upstage", "vercel", "voyage", "windsurf", "xiaomi", "z-ai"]

OrganisationIdList = List[Literal["ai21", "aion-labs", "allenai", "amazon", "anthropic", "arcee-ai", "baidu", "black-forest-labs", "bytedance", "cohere", "cursor", "deepseek", "eleven-labs", "essential-ai", "github", "google", "ibm", "inception", "inclusionai", "kwaipilot", "lg", "liquid-ai", "meituan", "meta", "microsoft", "minimax", "mistral", "moonshotai", "naver-hyperclova", "nex-agi", "nous", "nvidia", "openai", "perplexity", "poe", "poolside", "prime-intellect", "qwen", "relace", "sourceful", "spacex-ai", "stepfun", "suno", "tencent", "upstage", "vercel", "voyage", "windsurf", "xiaomi", "z-ai"]]
