...
class ListOrganisations200ResponseOrganisationsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["organisation_id", "name", "country_code", "description", "colour"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListOrganisations200ResponseOrganisationsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListOrganisations200ResponseOrganisationsInner from a dict"""
        if obj is None:
            return None
