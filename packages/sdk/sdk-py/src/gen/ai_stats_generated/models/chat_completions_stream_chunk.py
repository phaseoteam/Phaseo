...
class ChatCompletionsStreamChunk(BaseModel):
    ...
    choices: Optional[List[ChatCompletionsStreamChoice]] = None
    usage: Optional[Usage] = None
    meta: Optional[Dict[str, Any]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "nativeResponseId", "object", "created", "model", "system_fingerprint", "service_tier", "choices", "usage", "meta"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChatCompletionsStreamChunk from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChatCompletionsStreamChunk from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "choices": [ChatCompletionsStreamChoice.from_dict(_item) for _item in obj["choices"]] if obj.get("choices") is not None else None,
