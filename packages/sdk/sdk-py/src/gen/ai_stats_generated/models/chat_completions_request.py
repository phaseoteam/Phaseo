...
class ChatCompletionsRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["model", "system", "messages", "reasoning", "frequency_penalty", "logit_bias", "max_output_tokens", "meta", "debug", "presence_penalty", "seed", "stream", "temperature", "tools", "max_tool_calls", "parallel_tool_calls", "tool_choice", "top_k", "logprobs", "top_logprobs", "top_p", "response_format", "modalities", "usage", "provider", "user_id", "service_tier"]
