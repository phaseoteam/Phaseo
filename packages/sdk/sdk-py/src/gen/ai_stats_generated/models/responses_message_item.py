...
class ResponsesMessageItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "role", "content", "tool_calls", "tool_call_id"]
    ...
    def role_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['system', 'developer', 'user', 'assistant', 'tool']):
            raise ValueError("must be one of enum values ('system', 'developer', 'user', 'assistant', 'tool')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResponsesMessageItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResponsesMessageItem from a dict"""
        if obj is None:
            return None
