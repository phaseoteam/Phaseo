...
class ResponsesStreamOutputTextDeltaEventData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["delta", "output_index", "item_id", "logprobs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResponsesStreamOutputTextDeltaEventData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResponsesStreamOutputTextDeltaEventData from a dict"""
        if obj is None:
            return None
