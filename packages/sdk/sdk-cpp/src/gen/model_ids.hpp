...
inline constexpr std::string_view INCLUSIONAI_LING_3_0_FLASH_VL_FREE = "inclusionai/ling-3.0-flash-vl:free";
...
inline constexpr std::array<std::string_view, 668> ALL = {
