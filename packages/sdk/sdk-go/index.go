...
// GetHealth retrieves the API health status.
func (c *Client) GetHealth(ctx context.Context) (map[string]interface{}, error) {
	_ = ctx
	return gen.Health(c.base, nil, nil, nil, nil)
}
...
func (c *Client) GenerateSpeech(ctx context.Context, req gen.AudioSpeechRequest) (interface{}, error) {
	_ = ctx
...
func (c AudioSpeechClient) Create(body any) (interface{}, error) {
...
func (c BatchesClient) Create(body any) (map[string]interface{}, error) {
	return gen.CreateBatch(c.base, nil, nil, nil, body)
}

func (c BatchesClient) Retrieve(batchID string) (map[string]interface{}, error) {
	return gen.RetrieveBatch(c.base, map[string]string{"batch_id": batchID}, nil, nil, nil)
}
...
func (c FilesClient) List() (map[string]interface{}, error) {
	return gen.ListFiles(c.base, nil, nil, nil, nil)
}

func (c FilesClient) Retrieve(fileID string) (map[string]interface{}, error) {
	return gen.RetrieveFile(c.base, map[string]string{"file_id": fileID}, nil, nil, nil)
}
...
func (c ModelsClient) List(params map[string]string) (map[string]interface{}, error) {
	return gen.ListModels(c.base, nil, params, nil, nil)
}
