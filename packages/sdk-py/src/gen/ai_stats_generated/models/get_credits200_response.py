...
class GetCredits200Response(BaseModel):
    """
    GetCredits200Response
    """ # noqa: E501
    ok: Optional[StrictBool] = None
    credits: Optional[GetCredits200ResponseCredits] = None
    __properties: ClassVar[List[str]] = ["ok", "credits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ok": obj.get("ok"),
            "credits": GetCredits200ResponseCredits.from_dict(obj["credits"]) if obj.get("credits") is not None else None
        })
        return _obj
