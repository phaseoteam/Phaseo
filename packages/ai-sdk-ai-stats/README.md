...
const aiStats = createAIStats({
  apiKey: 'your_api_key',
  baseURL: 'https://api.ai-stats.phaseo.app/v1', // optional
  headers: {
...
- `settings.baseURL` (string, optional) - Gateway base URL. Default: `https://api.ai-stats.phaseo.app/v1`
...
```typescript
import type { AIStatsSettings, AIStatsModelSettings } from '@ai-stats/ai-sdk-provider';
