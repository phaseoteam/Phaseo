...
- [#1685](https://github.com/phaseoteam/Phaseo/pull/1685) [`daa0275`](https://github.com/phaseoteam/Phaseo/commit/daa02757701eae300a06870a4817df60dd94e28d) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Add one-command installation and setup for the primary coding harnesses, including direct `phaseo <harness>` shortcuts, compatible model-catalog sync, and automatic credential handling.
