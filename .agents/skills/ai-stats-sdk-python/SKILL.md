---
name: ai-stats-sdk-python
description: Implement AI Stats integrations with the official Python SDK (`ai-stats-py-sdk`). Use when repositories already depend on `ai_stats`, need a new client setup, Responses API calls, async video jobs, preset usage, or request logging patterns for the Python SDK surface.
---

# AI Stats SDK Python

Use this skill when the repository should call AI Stats through `ai-stats-py-sdk` instead of raw `httpx`, `requests`, or another compatibility client.
