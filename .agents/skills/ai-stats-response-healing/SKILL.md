---
name: ai-stats-response-healing
description: Configure and debug AI Stats response healing for structured JSON workflows. Use when a repository needs preset or workspace plugin defaults, request-level plugin overrides, malformed JSON recovery, or log-based verification of healing behavior.
---

# AI Stats Response Healing
