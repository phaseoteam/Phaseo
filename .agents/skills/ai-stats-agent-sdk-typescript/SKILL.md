---
name: ai-stats-agent-sdk-typescript
description: Build agentic applications with the TypeScript Agent SDK (`@ai-stats/agent-sdk`) on top of AI Stats Gateway. Use when repositories need local tool loops, resumable runs from app-owned state, or a gateway-backed agent client through `@ai-stats/sdk`.
---

# AI Stats Agent SDK TypeScript

Use this skill when the repository should implement agent-style workflows through `@ai-stats/agent-sdk`.
