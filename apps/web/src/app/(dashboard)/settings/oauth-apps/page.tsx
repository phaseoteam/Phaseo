...
export default async function OAuthAppsPage() {
	...
	// Fetch OAuth apps for the active team using the view with stats
	...
	return (
		<div className="space-y-6">
				...
				<div className="flex items-start gap-3">
					...
					<div className="flex-1">
						...
						<p className="text-sm text-yellow-800 dark:text-yellow-200 mt-1">
							This feature is in alpha testing. Please report any
							issues or feedback{" "}
							<a
						...
						<ul className="text-xs text-yellow-700 dark:text-yellow-300 mt-2 space-y-1 list-disc list-inside">
							...
							<li>
								Not recommended for critical integrations yet
							</li>
						</ul>
					</div>
				</div>
			...
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-sm text-muted-foreground mt-1">
						Create OAuth applications to enable third-party
						integrations with your AI Stats account
					</p>
				</div>
				<div className="flex items-center gap-2">
					<Link
			...
			<Suspense fallback={<div>Loading OAuth apps...</div>}>
				<OAuthAppsPanel
					oauthApps={oauthApps ?? []}
