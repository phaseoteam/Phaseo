...
export async function generateMetadata({
	...
	if (!country) {
		return buildMetadata({
			...
			description:
				"Browse AI models by country on Phaseo. This location does not yet have tracked organisations or releases, but we will surface providers, launches, and benchmarks as coverage expands.",
			path,
	...
	return buildMetadata({
		...
		path,
		keywords: [country.countryName, "AI models", "Phaseo"],
		imagePath,
	});
}
