...
The model quality curve is moving just as quickly. Releases tracked in Phaseo, including [Claude Fable 5](https://phaseo.ai/models/anthropic/claude-fable-5) and [Claude Mythos 5](https://phaseo.ai/models/anthropic/claude-mythos-5), show how often teams need to re-evaluate quality, availability, pricing, and provider support.
...
- the main site moves to `phaseo.ai`
...
## The main site is moving to phaseo.ai
