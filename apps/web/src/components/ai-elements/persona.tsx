        ...
        <span className={cn("relative inline-flex shrink-0", className)}>
          {!inputsApplied ? (
            <span
              ...
              aria-hidden="true"
            >
              <span className="h-[62%] w-[62%] rounded-full border border-border/70 bg-muted/30 shadow-inner" />
              <span className="absolute h-[38%] w-[38%] rounded-full bg-background/80" />
            </span>
          ) : null}
          <RiveComponent
            className={cn(
              "size-full shrink-0 transition-opacity duration-200",
              inputsApplied ? "opacity-100" : "opacity-0",
            )}
          />
        </span>
      </Component>
