      ...
      {children ?? (
        <>
          ...
          <div className="space-y-2">
            <Progress className="bg-neutral-100 dark:bg-neutral-800" value={usedPercent * PERCENT_MAX} />
          </div>
        </>
      )}
    </div>
...
export const ContextContentFooter = ({
  ...
  return (
    <div
      className={cn(
        "flex w-full items-center justify-between gap-3 bg-neutral-100 p-3 text-xs dark:bg-neutral-800",
        className
      )}
      {...props}
    >
