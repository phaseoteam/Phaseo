	...
	return (
		...
		>
			...
			<div
				data-slot="sidebar-container"
				className={cn(
					"fixed inset-y-0 z-10 group-data-[collapsible=icon]:z-60 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
					side === "left"
...
function SidebarTrigger({
	...
	// When collapsed, some group-data Tailwind rules can hide elements.
	// Use an inline style to ensure the trigger remains visible in collapsed mode.
