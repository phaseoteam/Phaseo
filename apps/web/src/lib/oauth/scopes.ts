...
export const OAUTH_SCOPE_OPTIONS: OAuthScopeOption[] = [
	...
	{ value: "private_models:read", label: "Read private models", description: "Inspect workspace private models.", group: "Read" },
	...
	{ value: "private_models:write", label: "Manage private models", description: "Create or update workspace private models.", group: "Write" },
	...
	{ value: "private_models:delete", label: "Delete private models", description: "Permanently delete workspace private models.", group: "Delete" },
