...
export type ModelOrganisation = { name: string; country_code?: string | null; colour?: string | null; color?: string | null; logo_url?: string | null };
export interface ModelPage { model_id: string; name: string; organisation_id: string; description?: string | null; hidden?: boolean; status?: string | null; previous_model_id?: string | null; announcement_date?: string | null; release_date?: string | null; deprecation_date?: string | null; retirement_date?: string | null; license?: string | null; input_types?: string | null; output_types?: string | null; family_id?: string | null; timeline?: any; updated_at?: string | null; organisation: ModelOrganisation; model_links: ModelLink[]; model_family?: { display_name: string } | null; model_details: { detail_name: string; detail_value: string | number | null }[]; pricing?: PricingRule[]; benchmark_results: Array<{ id: number; score: string | number; is_self_reported: boolean; other_info: string | null; source_link: string | null; created_at: string; updated_at: string; benchmark: { id: number; name: string; category: string | null; ascending_order: boolean; link: string | null; type?: "percentage" | "numerical" | null } }> }
type ModelStatus = "Rumoured" | "Announced" | "Preview" | "Limited Access" | "Withheld" | "Available" | "Deprecated" | "Retired" | null;
export interface ModelOverviewPage { model_id: string; name: string; organisation_id: string; description?: string | null; aliases?: string[]; variants?: ModelVariantSummary[]; variant_kind?: string; base_model_id?: string | null; status: ModelStatus; announcement_date?: string | null; release_date?: string | null; deprecation_date?: string | null; retirement_date?: string | null; license?: string | null; license_url?: string | null; input_types?: string | null; output_types?: string | null; previous_model_id?: string | null; family_id?: string | null; updated_at?: string | null; organisation: ModelOrganisation; is_private?: boolean; model_links: ModelLink[]; model_family?: { display_name: string } | null; model_details: { detail_name: string; detail_value: string | number | null }[]; pricing?: PricingRule[] }
