...
description: "From signup to first successful request in under 5 minutes, starting on a free model."
---

Use this guide to make your first successful AI Stats request in a few minutes.
...
If you use the Responses API directly, read the assistant reply from `output[].content[]` where `type` is `output_text`.
...
<Columns cols={2}>
	...
	<Card title="Support" icon="message-circle" href="./community/contact-and-support">
