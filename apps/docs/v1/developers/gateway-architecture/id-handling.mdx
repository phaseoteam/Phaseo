---
title: "ID Handling"
description: "Understanding request and response ID tracking in the Phaseo Gateway"
---

## Overview

The Phaseo Gateway tracks multiple types of IDs throughout the request lifecycle to enable debugging, correlation, and proper attribution. This document explains the different ID types and how they're used.
