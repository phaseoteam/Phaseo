...
- `v1/data/*` wires OpenAI- and Anthropic-compatible inference surfaces (chat, responses, messages, files, media).
- `v1/control/health.ts`, `v1/control/models.ts`, and `v1/control/analytics.ts` cover platform and utility endpoints.
