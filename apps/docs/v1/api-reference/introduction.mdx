...
an `Authorization: Bearer` header. Keys use the format
...
| `GET /models`, `GET /providers`, `GET /health`, `GET /generations?id=...`, `GET/POST /management/keys`, `GET/PATCH/DELETE /management/keys/{id}` | Control-plane discovery and management endpoints. |
