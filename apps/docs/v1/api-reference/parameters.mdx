...
Use this when you want to pass OpenAI cache-retention options without nesting them under provider-specific options. The provider-specific alias `provider_options.openai.prompt_cache_retention` remains accepted.
