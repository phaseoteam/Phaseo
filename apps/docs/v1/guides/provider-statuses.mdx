...
description: "What Active, Coming Soon, Deranked, Not Active, and Disabled mean on AI Stats model pages."
---
...
| `Not Active` | AI Stats knows about the provider or mapping, but it is not currently available for public routing. | Not routable now. |
...
`Coming Soon` is used when AI Stats has catalog coverage for a provider/model mapping before that mapping is publicly routable.
