...
- TypeScript SDK: `client.streamResponses()`, `client.streamChat()`, and `client.streamMessages()`
- Python SDK: `client.stream_responses()`, `client.stream_chat()`, and `client.stream_message()`
