...
Streaming tool calls depend on model and provider support. Accumulate all argument deltas before parsing, validating, or executing a call. See [Streaming](./streaming.mdx).
