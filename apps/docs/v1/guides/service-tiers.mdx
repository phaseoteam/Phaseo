...
- [Anthropic Messages API reference](/v1/api-reference/endpoint/anthropic-messages)
- [Chat Completions API reference](/v1/api-reference/endpoint/chat-completions)
- [Responses API reference](/v1/api-reference/endpoint/responses)
- [Shared parameter reference](/v1/api-reference/parameters)
...
- [Chat Completions API reference](/v1/api-reference/endpoint/chat-completions)
- [Responses API reference](/v1/api-reference/endpoint/responses)
- [Parameters](/v1/api-reference/parameters)
- [Routing and Fallbacks](/v1/guides/routing-and-fallbacks)
- [Chat completions (TypeScript SDK)](/v1/sdk-reference/typescript/chat-completions)
- [Responses (TypeScript SDK)](/v1/sdk-reference/typescript/responses)
