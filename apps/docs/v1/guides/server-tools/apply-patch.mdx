...
Use `ai-stats:apply_patch` when a Responses workflow should return file changes as structured patch operations. Phaseo validates the operation and returns it to your client; it does not mutate your filesystem or repository.
