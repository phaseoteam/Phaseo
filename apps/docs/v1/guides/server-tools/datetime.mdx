...
The model decides when to call the tool. AI Stats returns the resolved timezones and current timestamps to the model, then the model writes the final answer.
