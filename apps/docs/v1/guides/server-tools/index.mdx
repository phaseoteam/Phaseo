---
title: "Server Tools"
description: "Let models call AI Stats-operated tools during a request."
---

Server tools are tools that AI Stats runs for you during a model request. The model decides when to call them, AI Stats executes the tool server-side, and the tool result is fed back into the model loop.
