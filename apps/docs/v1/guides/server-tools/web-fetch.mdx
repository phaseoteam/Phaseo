...
curl https://api.phaseo.ai/v1/chat/completions \
  ...
  -d '{
    ...
    "messages": [
      { "role": "user", "content": "Summarize https://docs.phaseo.ai/v1/guides/tool-calling" }
    ],
    "tools": [
...
```json
{
  "provider": "fetch",
  "engine": "direct",
  "url": "https://docs.phaseo.ai/v1/guides/tool-calling",
  "final_url": "https://docs.phaseo.ai/v1/guides/tool-calling",
  "status": 200,
