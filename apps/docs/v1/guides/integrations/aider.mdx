---
title: "Aider"
icon: "/icons/brands/aider.png"
description: "Connect Aider to Phaseo with an automatically managed configuration."
---

Use the Phaseo CLI to create a dedicated key and managed Aider configuration, or copy the same provider values into an existing Aider configuration yourself.

## Set up with the Phaseo CLI

```bash
phaseo login
phaseo aider --model anthropic/claude-sonnet-4.6
```
