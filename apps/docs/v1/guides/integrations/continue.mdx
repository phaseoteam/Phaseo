...
icon: "plug"
title: "Continue"
icon: "/icons/brands/continue.svg"
description: "Add Phaseo to Continue in VS Code, JetBrains, or Continue CLI."
---

Use the Phaseo CLI to create a local Continue configuration shared by the IDE extensions and the `cn` command-line interface, or add the same model and secret values to your existing Continue configuration manually.

## Set up with the Phaseo CLI

```bash
phaseo login
phaseo continue --model anthropic/claude-sonnet-4.6
```
