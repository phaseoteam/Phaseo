...
Use this guide to route supported Cursor chat models through Phaseo. Use the Phaseo CLI to create and revoke a dedicated key, then finish setup in Cursor, or provide your own Phaseo key and follow the same manual settings.
