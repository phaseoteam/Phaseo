...
If you want Claude Code to read the live AI Stats documentation during a session, add the [Docs MCP](./docs-mcp.mdx) server too.
...
- You can also set `ANTHROPIC_MODEL` to an AI Stats model id when you want Claude Code to use one default model.
