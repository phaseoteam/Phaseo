...
Use the [Health endpoint](/v1/api-reference/endpoint/health) to inspect provider health, routing scores, and breaker status.
...
- [Rate limits](/v1/developers/rate-limits)
- [Error handling](/v1/developers/error-handling)
