...
<Update label="12th March 2026">
# Provider Expansion: Novita and Cerebras Added

We rolled out **Novita** and **Cerebras** across AI Stats today to expand model choice and improve reliability.

### [Novita](https://novita.ai/docs/guides/introduction)
Novita is an AI inference platform focused on giving developers broad API access to modern model catalogs without self-hosting infrastructure. It is especially useful when teams want to evaluate and ship quickly across multiple open and commercial model families.

You can explore [Novita performance on AI Stats](https://ai-stats.phaseo.app/api-providers/novita) and [see supported Novita models](https://ai-stats.phaseo.app/api-providers/novita/models).

Novita has allowed us to expand by **68 models**.

![Novita](../images/Novita.png)

### [Cerebras](https://inference-docs.cerebras.ai/)
Cerebras is an AI infrastructure and inference provider built for high-throughput model execution at scale. It gives teams another production-grade route for serving advanced models with strong performance and reliability expectations.

You can explore [Cerebras performance on AI Stats](https://ai-stats.phaseo.app/api-providers/cerebras) and [see supported Cerebras models](https://ai-stats.phaseo.app/api-providers/cerebras/models).

Cerebras has allowed us to expand by **2 models**.

![Cerebras](../images/Cerebras.png)

Across these two providers, this expansion increases our model catalog by **70 models** and adds even more endpoint coverage.

For day-to-day usage, this improves stability through stronger provider redundancy, more routing flexibility, and better fallback options for the models you use most.
