...
Phaseo tracks three main performance metrics for every model and provider:
...
Phaseo uses **standardised benchmarking scripts** to gather real-world performance data for each model and provider.
...
For transparency, raw performance data is often available through the open [Performance Dataset](https://github.com/phaseoteam/Phaseo) and the catalog endpoints documented in the Phaseo Gateway API reference.
