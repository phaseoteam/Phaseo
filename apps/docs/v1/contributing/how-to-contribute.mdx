...
description: "A step-by-step guide on how to make your first contribution to Phaseo - from setting up your environment to submitting a pull request."
---

Contributing to **Phaseo** is simple, transparent, and open to everyone.
...
| **Node.js (v20+)** | Runs the Phaseo site locally (Next.js).      | [Download Node.js](https://nodejs.org/en/download) |
...
Go to the [Phaseo GitHub Repository](https://github.com/phaseoteam/Phaseo) and click **Fork** in the top-right corner.
...
Once your PR is reviewed and approved, it will be merged into the main Phaseo repository.
...
<Card
	...
	icon="users"
	href="https://phaseo.app/contribute"
	horizontal
>
