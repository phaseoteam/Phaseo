...
description: "Learn how to contribute data, documentation, or improvements to the Phaseo project and help build the world's most comprehensive AI database."
---

Phaseo is an **open and community-driven project** - designed to make as much information about AI models, benchmarks, and providers freely accessible to everyone.
...
Your name will also appear in the [Contributors page](https://phaseo.app/contribute), recognizing your contributions.
...
1. **Fork** the [Phaseo GitHub repository](https://github.com/phaseoteam/Phaseo).
...
Once reviewed and approved, your contribution will be merged and visible in the live Phaseo database.
...
-   Ask in the [Phaseo Discord](https://discord.gg/aQyywCvgZ5).
...
<Columns cols={2}>
	...
	>
		Learn how the Phaseo repository is organized.
	</Card>
</Columns>
