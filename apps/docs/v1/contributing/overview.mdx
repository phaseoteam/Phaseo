...
3. **Edit the JSON or Markdown files** according to the structure outlined in [Repo Structure](/v1/contributing/repo-structure).
...
-   **Respectful Communication:** Follow our [Code of Conduct](/v1/community/code-of-conduct).
...
<Card
	...
	icon="handshake"
	href="/v1/contributing/how-to-contribute"
	horizontal
>
...
<Columns cols={2}>
	...
	<Card
		...
		icon="folder-tree"
		href="/v1/contributing/repo-structure"
	>
