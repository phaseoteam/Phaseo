...
description: "Understand how the Phaseo repository is organized - where to find data, documentation, and configuration files."
---
...
Phaseo/
+-- apps/
¦   +-- web/ # The main Phaseo Next.js website (contains data)
¦   +-- api/ # The Phaseo Gateway API (Hono/Cloudflare Workers)
...
| Path         | Description                                                                                       |
| ------------ | ------------------------------------------------------------------------------------------------- |
| `/apps/web`  | Main Phaseo website, built with Next.js 15 and TailwindCSS. Reads canonical data from `packages/data/catalog/src/data`. |
...
| `sdk-rust`   | Rust SDK.                                        |
| `sdk-cpp`    | C++ SDK.                                         |
| `ai-sdk-phaseo` | Vercel AI SDK provider.                      |

---

## Automation and scripts

Phaseo uses automation to keep data up to date:
