...
# Pricing and Provider Coverage Updates

### Qwen

- Updated [Qwen 3.6 Max Preview](https://ai-stats.phaseo.app/models/qwen/qwen3.6-max-preview) Alibaba Cloud pricing tiers.
- Added explicit cache creation and cache read pricing for tiered requests.
- Added model context details for input and output context lengths.

### Moonshot AI

- Expanded [Kimi K2.6](https://ai-stats.phaseo.app/models/moonshot-ai/kimi-k2.6) provider coverage and pricing metadata across:
  - [Moonshot AI](https://ai-stats.phaseo.app/api-providers/moonshotai)
  - [Novita](https://ai-stats.phaseo.app/api-providers/novita)
  - [Baseten](https://ai-stats.phaseo.app/api-providers/baseten)
