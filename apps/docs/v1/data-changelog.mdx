...
rss: true
---
<Update label="24th April 2026">
# Model Additions

### DeepSeek

- [DeepSeek V4 Flash](https://ai-stats.phaseo.app/models/deepseek/deepseek-v4-flash)
- [DeepSeek V4 Pro](https://ai-stats.phaseo.app/models/deepseek/deepseek-v4-pro)
- Official announcement: [DeepSeek V4 Preview Release](https://api-docs.deepseek.com/news/news260424)

![DeepSeek V4](../images/deepseek-v4.png)
...
- [GPT 5.5](https://ai-stats.phaseo.app/models/openai/gpt-5.5)
- [GPT 5.5 Pro](https://ai-stats.phaseo.app/models/openai/gpt-5.5-pro)
- Official announcement: [Introducing GPT-5.5](https://openai.com/index/introducing-gpt-5-5/)

![GPT 5.5](../images/gpt-5.5.png)
...
- [MiMo V2.5](https://ai-stats.phaseo.app/models/xiaomi/mimo-v2.5)
- [MiMo V2.5 Pro](https://ai-stats.phaseo.app/models/xiaomi/mimo-v2.5-pro)
- [MiMo V2.5 TTS](https://ai-stats.phaseo.app/models/xiaomi/mimo-v2.5-tts)
- Official announcement: [MiMo V2.5 News](https://platform.xiaomimimo.com/docs/news/v2.5-news)

![MiMo V2.5](../images/mimo-v2.5.png)
