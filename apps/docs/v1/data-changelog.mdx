...
We introduced the following new model tracking entry:

### xAI

- [Grok 4.2](https://ai-stats.phaseo.app/models/x-ai/grok-4-2)

![Grok 4.2](../images/grok-4.2.png)

# Database Updates

Added Grok 4.2 to the model database and linked it into xAI coverage so it can be tracked across AI Stats surfaces.
...
Added and aligned metadata support for Gemini Embedding 2 Preview across the database.
...
We introduced the following new models:
...
Added and aligned metadata support for GPT 5.4 and GPT 5.4 Pro across the database, and surfaced both models through the API.
...
Added and aligned metadata/pricing support for Gemini 3.1 Flash Lite Preview across tracked provider surfaces.
...
Added and aligned metadata/pricing support for Gemini 3.1 Flash Image Preview coverage across tracked provider surfaces.
...
Added and aligned metadata/pricing support for OpenAI Realtime and Audio 1.5 model coverage across tracked provider surfaces.
