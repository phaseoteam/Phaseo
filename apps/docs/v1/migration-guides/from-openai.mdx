...
description: "Step-by-step guide to migrate your OpenAI SDK integration to Phaseo Gateway."
---
...
-   A Phaseo account and API key (get one at [Gateway Keys](https://phaseo.app/gateway/keys))
...
Phaseo supports a wide range of models. Check the [models endpoint](../api-reference/endpoint/models) for available models and their names.
...
-   Check out the [API Reference](../api-reference/introduction) for full documentation.
