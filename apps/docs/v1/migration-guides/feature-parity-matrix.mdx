...
description: "Repo-grounded matrix for migration and compatibility parity across OpenRouter, Vercel AI Gateway, and LLMGateway."
---
...
It is intentionally based on code, tests, SDKs, and docs already in this repo rather than live competitor traffic.
