...
description: "Learn how Phaseo collects, normalises, and publishes benchmark results."
...
-   **Community submissions** — Verified contributions from the Phaseo community and partners.
...
1.  Open an issue with the evidence described in [Submit benchmark scores](./submitting-scores.mdx).
2.  Respond to review questions in the issue. Maintainers publish verified corrections through the database editor.
3.  Reach out in Discord to coordinate larger research submissions.
