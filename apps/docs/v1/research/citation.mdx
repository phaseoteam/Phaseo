...
> This work uses model metadata and aggregated benchmark results from [Phaseo](https://phaseo.ai).
...
```text
Phaseo. (2025). Phaseo: Aggregated benchmarks and gateway for AI models. https://phaseo.ai
```
