---
title: "Cookbook"
description: "Scenario-driven recipes for shipping with Phaseo faster."
---
...
<Columns cols={2}>
	<Card title="Launch on the free router" icon="sparkles" href="./free-router-first-deploy">
		Start on `phaseo/free` and let Phaseo choose an available free model for you.
	</Card>
...
<Columns cols={2}>
	...
	<Card title="Sort providers by price, latency, or throughput" icon="arrow-up-narrow-wide" href="./sort-providers-by-price-latency-or-throughput">
		Keep one model ID and choose whether Phaseo should prefer lower cost, faster responses, or higher throughput.
	</Card>
