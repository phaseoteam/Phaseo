...
description: "Build local, resumable agent loops on top of AI Stats Gateway across the supported SDK languages."
---
...
The TypeScript package is still the most feature-complete today, but all listed languages now expose the same baseline quickstart surface for local tool-driven loops.
