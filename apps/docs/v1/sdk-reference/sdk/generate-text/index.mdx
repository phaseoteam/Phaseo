...
description: "Non-streaming text generation with Vercel AI SDK and AI Stats."
---
...
- Keep model IDs dynamic by querying `/v1/gateway/models` (see [Model Discovery](/v1/sdk-reference/sdk/get-models/index)).
