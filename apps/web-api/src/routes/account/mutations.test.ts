...
describe("account mutation boundaries", () => {
	it.each([
		...
		["POST", "/api/account/settings/billing/payment-methods", { returnUrl: "https://phaseo.app/settings/payment-methods" }],
		["PATCH", "/api/account/settings/billing/payment-methods", { paymentMethodId: "pm_test" }],
		["DELETE", "/api/account/settings/billing/payment-methods", { paymentMethodId: "pm_test" }],
		["POST", "/api/account/settings/billing/invoice-document", { stripeInvoiceId: "in_test" }],
		["POST", "/api/account/settings/billing/purchase-document", { paymentIntentId: "pi_test" }],
		["POST", "/api/account/settings/billing/portal", { returnUrl: "https://phaseo.app/settings/credits" }],
		["POST", "/api/account/settings/billing/refund", { paymentIntentId: "pi_test", reason: "no_comment" }],
		["POST", "/api/account/settings/billing/charge-saved", { amount_pence: 500 }],
		["POST", "/api/account/settings/billing/checkout", { kind: "oneoff", amount_pence: 500 }],
