...
describe("chat route boundary", () => {
	it.each(["text", "playground", "audio", "image", "video", "embeddings", "moderation", "realtime/session", "live/session"])("requires bearer authentication for POST /api/chat/%s", async (route) => {
