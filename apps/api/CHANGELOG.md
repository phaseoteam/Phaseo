...
- [#2404](https://github.com/phaseoteam/Phaseo/pull/2404) [`23c6230`](https://github.com/phaseoteam/Phaseo/commit/23c62300ddef8f36d3256ed112ed813c898ac576) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Support Gemini 3.8 Live and Gemini 3.8 Live Extended Thinking in realtime voice sessions, including configurable reasoning levels and background-reasoning lifecycle handling.
...
- [#2223](https://github.com/phaseoteam/Phaseo/pull/2223) [`186a11f`](https://github.com/phaseoteam/Phaseo/commit/186a11f307615fb59637e4f72f9464225c28d134) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Stream complete batch results through one authenticated JSONL download endpoint across supported providers. Include separate error files, preserve provider-native result fields, and retain existing file APIs without additional inference charges.
...
- [#2384](https://github.com/phaseoteam/Phaseo/pull/2384) [`f0fbb26`](https://github.com/phaseoteam/Phaseo/commit/f0fbb26e2bf13b5b25335a102125e48507eccec2) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Add Doubleword as an OpenAI-compatible gateway provider with Responses API transport, reasoning controls, service-tier normalization, and live model discovery.
...
- [#2414](https://github.com/phaseoteam/Phaseo/pull/2414) [`47e15db`](https://github.com/phaseoteam/Phaseo/commit/47e15dba68fbd3af47bdaa6c6e2a8712e67b9e8c) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Add an explicit OpenRouter text executor and runtime binding so the public Union Alpha route can be used through OpenRouter.
...
- [#2222](https://github.com/phaseoteam/Phaseo/pull/2222) [`24368b9`](https://github.com/phaseoteam/Phaseo/commit/24368b945c71baea0020a60ee3376abb098f0374) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Expose authenticated, streamed Anthropic batch result downloads and return the Phaseo download URL in batch responses. Preserve workspace ownership and avoid additional inference charges on downloads. Clarify that webhook retries only follow failed deliveries.
  
  Add TypeScript and Python streaming batch-result helpers with cancellation and early-close support for large outputs.

- [#2216](https://github.com/phaseoteam/Phaseo/pull/2216) [`18939f5`](https://github.com/phaseoteam/Phaseo/commit/18939f558b73f2d6e383c8614f8a5e64596ae210) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Record actual async wallet charges atomically in the credit ledger, with reservation-based idempotency and accurate captured/released hold counters. Ledger write failures roll back settlement. Holds, releases and zero-cost results do not create charge entries.
...
- [#2216](https://github.com/phaseoteam/Phaseo/pull/2216) [`18939f5`](https://github.com/phaseoteam/Phaseo/commit/18939f558b73f2d6e383c8614f8a5e64596ae210) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Capture unexpected zero-cost Video and Batch billing anomalies durably and route them to an operations Slack destination with recorded delivery attempts and settlement resolution.
  
  Disable staging gateway schedules while staging shares the production database, preventing staging consumers from claiming production notification and reconciliation work.
...
- [#2399](https://github.com/phaseoteam/Phaseo/pull/2399) [`671e226`](https://github.com/phaseoteam/Phaseo/commit/671e226a209630edf89c39f19e29d18b9ead7703) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Count only active, unblocked, unexpired API and management keys toward their respective workspace key limits so inactive or expired credentials do not prevent new key creation.

- [#2292](https://github.com/phaseoteam/Phaseo/pull/2292) [`fd0dfef`](https://github.com/phaseoteam/Phaseo/commit/fd0dfef1e724939ef16a02b6acfce66f642b5fef) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Forward CrofAI reasoning effort settings to the upstream OpenAI-compatible API.
...
- [#2069](https://github.com/phaseoteam/Phaseo/pull/2069) [`c1bb5fe`](https://github.com/phaseoteam/Phaseo/commit/c1bb5fec8cf90cdda69c3e92a5bfef4f9e11547d) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Fix conditional pricing fallback behavior, align provider capability registration with executable endpoints, and add Xiaomi audio transcription support.
...
- [#2218](https://github.com/phaseoteam/Phaseo/pull/2218) [`d1a5819`](https://github.com/phaseoteam/Phaseo/commit/d1a5819cca75041ef4469d94958d74fc0c2ff38e) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Fix Google Vertex service-account authentication on Cloudflare Workers while continuing to reject credential-bearing redirects.

- [#2216](https://github.com/phaseoteam/Phaseo/pull/2216) [`18939f5`](https://github.com/phaseoteam/Phaseo/commit/18939f558b73f2d6e383c8614f8a5e64596ae210) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Recover expired Video and Batch webhook claims, validate current delivery state without cached reads, and transactionally queue Batch lifecycle events. Protect delivery results with claim ownership and preserve the initial attempt plus three recorded retries. Reject native media overrides in video provider options and correctly route Fal frame and reference inputs.
...
- [#2350](https://github.com/phaseoteam/Phaseo/pull/2350) [`a3a4516`](https://github.com/phaseoteam/Phaseo/commit/a3a451620900850f69cc2eea263b43f7d77ea680) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Ignore legacy string availability values while parsing gateway context so valid provider routes remain usable.
...
- [#2360](https://github.com/phaseoteam/Phaseo/pull/2360) [`ce235c2`](https://github.com/phaseoteam/Phaseo/commit/ce235c23709f62d6b75651f5dcfbaa2435fe3969) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Stream model text and tool-call deltas as they arrive while gateway-managed tools run between model turns.
...
- [#2269](https://github.com/phaseoteam/Phaseo/pull/2269) [`e817e48`](https://github.com/phaseoteam/Phaseo/commit/e817e48c1509890b1b50ca0f89bfc0a7b94630c2) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Expand native provider coverage for images, speech, transcription, embeddings, reranking, document operations and video. Add DeepInfra callback-based video settlement and Black Forest Labs video jobs, correct Novita and xAI video routing, and activate verified existing offers across Azure, Vertex, Baidu, Stepfun, Parasail, DeepInfra, Black Forest Labs and GMI with matching prices.
  
  Preserve provider options and reasoning through IR, correct multimodal usage and regional routing, and add a repeatable coverage audit. Retain asynchronous Runway image/audio and Stepfun transcription offers as disabled catalog entries pending durable media-job support.
...
- [#2356](https://github.com/phaseoteam/Phaseo/pull/2356) [`654f8d3`](https://github.com/phaseoteam/Phaseo/commit/654f8d31da3638efa95816269127671a572ad8a8) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Treat omitted and `default` text service tiers as Standard when choosing providers, require explicit Flex for dedicated Flex offers, and label Flex pricing as opt-in on model pages.
...
- [#2216](https://github.com/phaseoteam/Phaseo/pull/2216) [`18939f5`](https://github.com/phaseoteam/Phaseo/commit/18939f558b73f2d6e383c8614f8a5e64596ae210) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Enforce API key budgets before paid video submission. Count outstanding video reservations alongside settled request usage, including when Video and Batch share a key. Preserve workspace-level reservation checks for OAuth requests.

- [#2349](https://github.com/phaseoteam/Phaseo/pull/2349) [`024374b`](https://github.com/phaseoteam/Phaseo/commit/024374bce7ca441ac81f15be02084396ec69e46f) Thanks [@DanielButler1](https://github.com/DanielButler1)! - Route Wafer ZDR offers through the Wafer executor and require zero data retention on their upstream requests.
