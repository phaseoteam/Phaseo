...
export async function fetchCatalogue(filter: CatalogueFilters): Promise<CatalogueModel[]> {
    ...
    for (const model of modelRows ?? []) {
        ...
        baseModels.set(model.model_id, {
            ...
            replacement_model_id: model.replacement_model_id ?? null,
