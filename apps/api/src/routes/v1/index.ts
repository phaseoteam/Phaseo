...
const CORS_HEADERS: Record<string, string> = {
    ...
    "Access-Control-Allow-Headers":
        "Authorization, Content-Type, x-title, http-referer, x-app-id, x-app-name, x-gateway-debug, x-phaseo-debug, X-Phaseo-Strictness, X-AIStats-Strictness, x-phaseo-cache-revalidate, x-aistats-cache-revalidate",
