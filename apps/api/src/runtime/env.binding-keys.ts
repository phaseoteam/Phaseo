...
export const BINDING_KEYS: Array<keyof GatewayBindings> = [
    ...
    "DISCORD_ROLE_ID",
    "DISCORD_ROLE_ID_MODEL_UPDATES",
    "DISCORD_USER_ID",
    "DISCORD_MODEL_DISCOVERY_AVATAR_URL",
    "HF_WATCH_ORGS",
    "HF_TOKEN",
    "GITHUB_TOKEN",
    "GH_TOKEN",
    ...
    "MODEL_DISCOVERY_HF_ENABLED",
    "MODEL_DISCOVERY_HF_GITHUB_ISSUES",
    "MODEL_DISCOVERY_INTERNAL_ENABLED",
    "MODEL_DISCOVERY_PROVIDER_GITHUB_ISSUES",
