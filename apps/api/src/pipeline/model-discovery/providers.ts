...
const PROVIDER_OVERRIDES: Record<string, ProviderOverride> = {
	...
	"amazon-bedrock": { providerName: "Amazon Bedrock (Converse)" },
	"amazon-bedrock-mantle": { providerName: "Amazon Bedrock (Mantle)" },
	...
	"thinking-machines": {
		...
		apiKeyEnv: ["THINKING_MACHINES_API_KEY", "TINKER_API_KEY"],
