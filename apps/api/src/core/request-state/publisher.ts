...
// durable mutation fence coalesces changes; a failed build leaves admission fenced.
export async function publishWorkspace(targets: PublicationTarget[]): Promise<void> {
