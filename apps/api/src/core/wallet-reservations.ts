...
export async function captureWalletReservation(args: {
	...
	if (isSyntheticWorkspace(args.workspaceId)) return workspaceState(args.workspaceId).capture(args.reservationId);
...
export async function releaseWalletReservation(args: {
	...
	if (isSyntheticWorkspace(args.workspaceId)) return workspaceState(args.workspaceId).release(args.reservationId);
...
export async function settleWalletReservation(args: {
	...
	if (isSyntheticWorkspace(args.workspaceId)) return workspaceState(args.workspaceId).settle(args.reservationId, args.actualNanos);
	const supabase = getSupabaseAdmin();
