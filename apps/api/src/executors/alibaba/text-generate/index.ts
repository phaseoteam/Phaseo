// Purpose: Executor for alibaba / text-generate.
// Why: Isolates provider-specific behavior per capability.
// How: Transforms IR and calls the provider API for this capability.

// Alibaba/Qwen Executor - OpenAI Compatible (DashScope)
// Documentation: https://help.aliyun.com/zh/model-studio/developer-reference/compatibility-of-openai-with-dashscope
