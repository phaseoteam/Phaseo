// Purpose: Executor for OpenRouter text generation.
// Why: Keeps the stealth model's direct OpenRouter route explicit and provider-owned.
// How: Sends the normalized request through OpenRouter's OpenAI-compatible Chat Completions API.
