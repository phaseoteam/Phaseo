// Purpose: Executor for Ambient text generation.
// Why: Keeps provider-specific behaviour behind an explicit provider boundary.
// How: Uses Ambient's OpenAI-compatible wire protocol and shared timing hooks.
