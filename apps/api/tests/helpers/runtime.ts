...
export function setupTestRuntime() {
    ...
    configureRuntime({
        ...
        AKASHML_BASE_URL: "https://api.akashml.example",
        ...
        CLARIFAI_PAT: "test-clarifai-key",
        CLARIFAI_BASE_URL: "https://api.clarifai.example",
        COHERE_API_KEY: "test-cohere-key",
        COHERE_BASE_URL: "https://api.cohere.example",
        VOYAGE_API_KEY: "test-voyage-key",
        VOYAGE_BASE_URL: "https://api.voyage.example",
        DEEPINFRA_API_KEY: "test-deepinfra-key",
        DEEPINFRA_BASE_URL: "https://api.deepinfra.example",
        DEEPSEEK_API_KEY: "test-deepseek-key",
        DEEPSEEK_BASE_URL: "https://api.deepseek.example",
        CROFAI_API_KEY: "test-crofai-key",
        CROFAI_BASE_URL: "https://api.crofai.example",
        ...
        FRIENDLI_BASE_URL: "https://api.friendli.example",
