# Agent setup for `ai-stats-public`

This is a deepsec scanning workspace. Project `ai-stats-public` was just registered
(target: `..`). Setup is incomplete — `data/ai-stats-public/INFO.md`
...
2. **Fill in `data/ai-stats-public/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id ai-stats-public
pnpm deepsec process --project-id ai-stats-public
```
